...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  'Why Does IoT Need Stronger Security in Business Environments?',
  'The Invisible Threat Beneath Smart Systems',
  'The Growing Impact of IoT Compromise',
  'How Auriseg Helps Organizations Stay Secure?',
  'Don’t Let Your Devices Do the Talking',
];
...
const SECTIONS = [
  {
    id: 's0',
    heading: 'Why Does IoT Need Stronger Security in Business Environments?',
    body: [
      <>
        The Internet of Things (IoT) has seamlessly integrated into modern offices, from
        <span style={{ color: '#FF5536' }}>
          {' '}smart cameras, access control systems, connected printers, voice assistants, and temperature sensors.
        </span>
        <br /><br />

        These devices promise automation, efficiency, and cost savings.
        Yet behind that convenience, they often introduce new pathways for cyber threats.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'The Invisible Threat Beneath Smart Systems',
    hasTable: true,
    body: [
      <>
        Unlike traditional IT assets, IoT devices are frequently installed with minimal oversight.
        Many operate on separate or poorly monitored networks, making them difficult to manage and secure.
        <br /><br />

        Once compromised, they can serve as
        <span style={{ color: '#FF5536' }}>
          {' '}invisible gateways for attackers to move laterally within an organisation’s infrastructure.
        </span>
        <br /><br />
        ...
        <br />
        ● Attackers exploit unpatched firmware vulnerabilities.
        <br />
        ● Unsecured communication protocols are exposing sensitive telemetry data.
        <br />
        ● Lack of network segmentation allows attackers to pivot from IoT to critical systems.
        <br /><br />

        A seemingly “smart” workplace can quickly transform into an exposed environment if these controls are ignored.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'The Growing Impact of IoT Compromise',
    body: [
      <>
        The true danger lies in the scale and connectivity of IoT ecosystems.
        Each device that joins the network expands the attack surface often without anyone noticing.
        <br /><br />

        A single vulnerable IoT endpoint can:
        <br /><br />

        ● Disrupt operations or join botnets for large-scale DDoS attacks.
        <br />
        ● Leak private data such as meeting audio, surveillance footage, or proprietary metrics.
        <br />
        ● Provide an initial foothold for broader phishing or ransomware campaigns.
        <br />
        ● Undermine compliance efforts by violating data protection standards.
        <br /><br />

        When businesses underestimate IoT risks, they unintentionally create blind spots that attackers are quick to exploit.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          Staying alert isn’t about fear; it’s about responsible cyber hygiene.
        </span>
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: 'How Auriseg Helps Organizations Stay Secure?',
    hasChecklist: true,
    body: [
      <>
        At Auriseg, we help businesses regain control over their connected environments through robust IoT security management.
        <br /><br />

        Our approach focuses on three pillars:
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Visibility:</span> Identifying all active IoT devices and their network relationships.
        <br />

        ● <span style={{ color: '#FF5536' }}>Monitoring:</span> Detecting anomalies, traffic patterns, and behavioural changes in real time.
        <br />

        ● <span style={{ color: '#FF5536' }}>Defence:</span> Implementing segmentation, patch management, and policy-based controls to protect critical assets.
        <br /><br />

        By combining intelligence, automation, and expert-led assessments,
        Auriseg ensures your “smart” workplace stays secure, efficient, and compliant without sacrificing innovation.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'Don’t Let Your Devices Do the Talking',
    body: [
      <>
        Partner with Auriseg to help you to keep your organisation’s IoT landscape in safe hands with the right strategy.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          Security isn’t an afterthought; it’s a built-in advantage.
        </span>
      </>
    ],
  },
