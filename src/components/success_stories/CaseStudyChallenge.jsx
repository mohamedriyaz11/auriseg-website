  ...
  const challenges = [
    {
      ...
      description: "Limited to business hours only, leaving clients vulnerable during nights and weekends."
    },
    {
      icon: "/images/success-stories/icons/icon-alert.png",
      title: "High Alert Fatigue",
      description: "Overwhelmed by thousands of daily security alerts with no efficient triage system."
    },
    {
      icon: "/images/success-stories/icons/icon-soc.png",
      title: "Lack of SOC Infrastructure",
      description: "No centralized SIEM or security orchestration platform to manage multiple client environments."
    },
    {
      icon: "/images/success-stories/icons/icon-hiring.png",
      title: "Hiring Challenges",
      description: "Unable to recruit and retain skilled security analysts in a competitive market."
    }
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              SecureEdge Solutions faced multiple obstacles preventing them from offering
              comprehensive security services to their growing client base.
            </p>
          </div>
