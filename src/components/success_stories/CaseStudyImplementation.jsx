...
const CaseStudyImplementation = () => {
  const steps = [
    {
      title: '1.  Connect Systems',
      description: 'Integrated existing SIEM and security tools with Auriseg platform',
      icon: '/images/success-stories/icons/connect-systems.png',
    },
    {
      title: '2.  Deploy Monitoring',
      description: 'Configured monitoring across all 45 client environments',
      icon: '/images/success-stories/icons/deploy-monitoring.png',
    },
    {
      title: '3.  Activate Detection Rules',
      description: 'Customized threat detection rules and playbooks',
      icon: '/images/success-stories/icons/activate-rules.png',
    },
    {
      title: '4.  Go Live',
      description: 'Full 24/7 SOC operations launched with white-label branding',
