  ...
  const caseStudies = [
    {
      ...
      description: "A regional public utility serving more than 1.2 million residents was operating with fragmented monitoring, limited OT visibility, aging remote access controls, and no unified incident response workflow across IT and operational teams.",
      challenge: [
        "Multiple remote substations and field assets lacked centralized security monitoring",
        "Legacy accounts and vendor access pathways remained active beyond business need",
        "OT and IT teams followed separate escalation processes, delaying incident coordination",
        "Executive leadership needed clearer reporting on resilience, risk exposure, and readiness"
      ],
      solution: [
        "Deployed centralized 24/7 SOC monitoring across enterprise and operational environments",
        "Implemented access governance and segmented remote connectivity for third parties and privileged users",
        "Built a unified incident response playbook covering cyber, operational, legal, and leadership stakeholders",
        "Established recurring risk reviews and executive reporting mapped to resilience priorities"
      ],
      impact: [
        {
          value: "",
          label: "Reduced detection and escalation time for high-risk events"
        },
        {
          value: "",
          label: "Improved visibility across previously unmonitored remote assets"
        },
        {
          value: "",
          label: "Strengthened vendor access governance and response readiness"
        },
        {
          value: "",
          label: "Gave leadership a clearer, evidence-based view of cyber risk and operational resilience"
        }
      ],
