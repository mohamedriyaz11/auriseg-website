  ...
  const cards = [
    {
      ...
      description: "Protect high-value transactions, reduce fraud exposure, and align controls to demanding regulatory environments."
    },
    {
      icon: "/icons/soc-augmentation/triage-escalation.png",
      title: "Healthcare & Life Sciences",
      description: "Secure sensitive health data, strengthen resilience, and support compliance across clinical and digital health environments."
    },
    {
      icon: "/icons/soc-augmentation/reporting.png",
      title: "Technology",
      description: "Defend cloud-native environments, development ecosystems, and customer-facing platforms without slowing innovation."
    }
  ];
