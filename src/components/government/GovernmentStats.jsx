...
const IndustriesStats = () => {
  const stats = [
    {
      value: "70%",
      description: "Of attacks based on critical infrastructure, underscoring how heavily adversaries are targeting essential sectors.",
    },
    {
      value: "$4.88M",
      description: "Global average cost of a data breach in 2024, with prolonged disruption and recovery costs putting even greater pressure on public and essential-service environments.",
    },
    {
      value: "292 days",
      description: "Average time to identify and contain breaches involving compromised credentials, one of the most dangerous attack paths in distributed public-sector environments.",
    }
  ];
