  ...
  const testimonials = [
    {
      ...
      quote: "Auriseg provided excellent service. Their vulnerability assessments and security testing revealed significant vulnerabilities in our applications and infrastructure, and their clear, practical remediation recommendations enabled our team to prioritise and address issues effectively. They are professional, thorough and highly effective and we recommend them",
      name: "",
      title: "CISO Of Madras Security Printers ",
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            {/* ── SINGLE BORDERED BOX — constrained width ── */}
            <div style={{
              width: '100%',
              maxWidth: '1080px',
              margin: '0 auto',
              ...
              <div style={{ flexShrink: 0 }}>
                <img
                  ...
                  style={{ width: '425px', height: '319px', borderRadius: '12px', objectFit: 'cover' }}
