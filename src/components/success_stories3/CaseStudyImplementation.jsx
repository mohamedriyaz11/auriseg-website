  ...
  const steps = [
    {
      ...
      description: 'Define scope, timelines, and testing constraints',
      icon: '/images/success-stories/icons/connect-systems.png',
    },
    {
      title: '2.  Automated & Manual Testing',
      description: 'Execute scans and validate vulnerabilities manually',
      icon: '/images/success-stories/icons/deploy-monitoring.png',
    },
    {
      title: '3.  Vulnerability Analysis',
      description: 'Identify critical risks and potential attack vectors',
      icon: '/images/success-stories/icons/activate-rules.png',
    },
    {
      title: '4.  Remediation Guidance',
      description: 'Provide actionable fixes for identified security gaps',
