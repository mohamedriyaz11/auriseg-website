  ...
  const challenges = [
    {
      ...
      description: "Conducted external testing using automated tools and manual validation"
    },
    {
      icon: "/images/success-stories/icons/Icon copy.png",
      title: "Network Vulnerability Assessment",
      description: "Identified weaknesses in perimeter systems through comprehensive scanning"
    },
    {
      icon: "/images/success-stories/icons/Icon copy 2.png",
      title: "Application Penetration Testing",
      description: "Tested web applications for exploitable vulnerabilities and attack vectors"
    },
    {
      icon: "/images/success-stories/icons/Icon copy 3.png",
      title: "Security Risk Profiling",
      description: "Leveraged advanced tools and expert analysis to prioritize risks effectively"
    }
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              The engagement focused on identifying and mitigating critical vulnerabilities through a structured VAPT approach aligned with industry best practices.
            </p>
          </div>
