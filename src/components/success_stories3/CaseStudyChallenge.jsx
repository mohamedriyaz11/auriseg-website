  ...
  const challenges = [
    {
      ...
      title: "Restricted Testing Environment",
      description: "Infrastructure limitations slowed down automated security testing activities"
    },
    {
      icon: "/images/success-stories/icons/icon-alert.png",
      title: "Time-Bound Testing Windows",
      description: "Assessments had to be completed within strict predefined timeframes"
    },
    {
      icon: "/images/success-stories/icons/icon-soc.png",
      title: "Complex IT Ecosystem",
      description: "Large-scale distributed systems increased difficulty in identifying vulnerabilities"
    },
    {
      icon: "/images/success-stories/icons/icon-hiring.png",
      title: "Risk of Critical Data Exposure",
      description: "Potential threats to sensitive operational and application data required immediate attention"
    }
  ];
