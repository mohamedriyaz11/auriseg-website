...
const stats = [
  { value: '1000+', label: 'Attack Paths Validated' },
  { value: '95%', label: 'Findings Included\nRemediation Guidance' },
  { value: '200+', label: 'Security Assessments Delivered' },
...
const steps = [
  {
    ...
    description: 'Define assets, goals, testing depth, compliance requirements, and authorized boundaries.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Recon & Enumeration',
    description: 'Map the environment, identify exposed services, and prioritize likely attack paths.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Exploitation & Validation',
    description: 'Test vulnerabilities manually, confirm exploitability, and chain weaknesses where appropriate.',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Reporting & Readout',
    description: 'Deliver a detailed report with evidence, severity, and remediation guidance.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Retest',
    description: 'Verify fixes and confirm that critical issues have been resolved.',
  ...
  return (
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        <section
          id="penetration-process-timeline"
          style={{
            width: '100%',
            maxWidth: '1440px',
            margin: '0 auto',
        ...
        >
          ...
          >
            Auriseg moves from scoping to testing quickly, with a structured process designed to minimize friction and maximize clarity.
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="penetration-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
