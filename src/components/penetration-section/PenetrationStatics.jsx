...
const stats = [
  { number: '95%', subNumber: '', description: 'Critical Findings Remediated Within 30 Days' },
  { number: '8-Days', description: 'Average Mean Time to Remediate Critical Vulnerabilities' },
  { number: '2400+', description: 'Vulnerabilities Discovered Across Client Environments' },
  { number: '100%', description: 'Engagements Delivered With Actionable Remediation Playbooks' },
];
