    ...
    const models = [
        {
            ...
            description: "A focused assessment of a defined scope, ideal for annual assurance, compliance needs, or pre-launch validation."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Continuous Testing Program",
            description: "Ongoing security testing across applications, infrastructure, and cloud environments to keep pace with change."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Targeted Adversary Simulation",
            description: "High-priority testing focused on the paths most likely to be used by real attackers, including credential abuse, privilege escalation, and sensitive-data access."
        }
    ];
