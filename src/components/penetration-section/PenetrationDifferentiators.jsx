...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Manual Depth",
            description: "Experienced testers go beyond automated scanning to validate exploitability, chained attack paths, and business impact."
        },
        {
            title: "Transparent Scoping",
            description: "Clear scope, assumptions, and rules of engagement from the start no surprise exclusions or unclear coverage."
        },
        {
            title: "Actionable Reporting",
            description: "Findings include risk context, proof of concept, remediation steps, and executive-ready summaries."
        },
        {
            title: "Fast Turnaround",
            description: "Defined timelines and structured delivery keep assessments moving without sacrificing rigor."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Security Assurance Proven in Practice
                        </h2>
