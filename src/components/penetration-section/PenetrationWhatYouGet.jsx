    ...
    const cards = [
        {
            ...
            description: "Auriseg tests your internet-facing assets from the attacker’s perspective, identifying exposed services, weak configurations, and exploitable entry points before they become breach paths."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Web & API Testing",
            description: "Every application and API is assessed for authentication flaws, access-control failures, injection risks, and business logic weaknesses — with findings tied to real abuse scenarios."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Internal & Cloud Testing",
            description: "Auriseg validates how far an attacker could move after initial access, testing privilege escalation, lateral movement, cloud misconfigurations, and sensitive data exposure."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Stronger Security Greater Scale
                        </h2>
                        ...
                        >
                            Every engagement includes manual exploitation, attack-path validation, and business-ready reporting built to uncover vulnerabilities that scanners miss.
                        </p>
