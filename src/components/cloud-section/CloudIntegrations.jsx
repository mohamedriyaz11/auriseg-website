...
const ThreatIntegrations = () => {
    const integrations = {
        ...
        edr: ['Prisma Cloud,', 'Lacework', 'Orca Security', 'Wiz'],
        firewall: ['Okta', 'Azure AD', 'AWS IAM'],
        cloud: ['Kubernetes', 'Docker', 'EKS', 'AKS']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg audits your existing cloud stack — no rip-and-replace required.
                            </p>
                        </div>
