...
const stats = [
  { value: '10K+', label: 'Cloud Tests Monthly' },
  { value: '95%', label: 'Risk Closure \nAvg. Client' },
  { value: '150+', label: 'MSP Partners Secured' },
  { value: '99.9%', label: 'Audit Accuracy Rate' },
];

const steps = [
  {
    title: '1. Scoping Call',
    description: 'Define cloud environments, testing scope, risk thresholds, and report formats.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Tool Integration ',
    description: 'Connect cloud APIs, security tools, and access controls to Auriseg platform.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Baseline Testing ',
    description: 'Map normal traffic, identify safe configurations, tune detection rules.',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Custom Test ',
    description: 'Plans Co-develop pentest scenarios and risk validation workflows.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Audit Complete ',
    description: 'Full report delivered. Remediation roadmap activated.',
    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Auriseg's streamlined audit process moves fast from contract to comprehensive cloud assurance in under two weeks.
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="cloud-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
