    ...
    const cards = [
        {
            ...
            description: "Auriseg experts scan your cloud environments around the clock. Every vulnerability is tested, prioritized, and validated with zero noise reaching your team."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Risk Investigation",
            description: "Every high-priority finding triggers structured penetration testing. Auriseg experts trace exploit paths, confirm real-world risks, and deliver documented proof, not vague scans."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Assurance & Remediation",
            description: "When risks are validated, Auriseg provides containment guidance, coordinates secure fixes, and delivers full audit reports  slashing exposure before breaches happen."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement delivers rigorous cloud testing, expert risk validation, and actionable assurance reports purpose-built for MSPs scaling secure cloud services.
                        </p>
