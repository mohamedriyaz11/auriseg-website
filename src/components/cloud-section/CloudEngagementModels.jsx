    ...
    const models = [
        {
            ...
            title: "Co-Managed Audit",
            description: "Your team keeps control. Auriseg experts act as embedded auditors sharing findings, tests, and remediations in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed Audit",
            description: "Offload entirely. Auriseg owns testing, validation, reporting, and assurance freeing your team for strategic growth."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Audit Augmentation",
            description: "Fill expertise gaps. Inject Auriseg cloud testing specialists for peak seasons, complex audits, or advanced pentesting on demand."
        }
    ];
