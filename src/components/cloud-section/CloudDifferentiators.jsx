    ...
    const features = [
        {
            ...
            description: "Full white-label audit portals, reports, and dashboards — branded entirely to your MSP."
        },
        {
            title: "Transparent Pricing",
            description: "Per-environment, per-scope pricing with no surprise fees. Forecast audit costs precisely and protect margins."
        },
        {
            title: "Expert Escalation Path",
            description: "Direct access to senior pentesters and cloud architects with no automated loops. Escalate critical risks in minutes."
        },
        {
            title: "Rapid Onboarding",
            description: "Dedicated audit lead owns your kickoff. From scoping to first report, operational in 72 hours or less."
        }
    ];
