...
const stats = [
  { number: '300+', subNumber: '', description: 'Audit checks per environment' },
  { number: '72-Hrs', description: 'Full report delivery' },
  { number: '95%', description: 'Critical findings closed in 30 days' },
  { number: '3-Major', description: 'Cloud platforms supported' },
];
