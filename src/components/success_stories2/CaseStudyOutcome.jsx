...
const CaseStudyOutcome = () => {
  const outcomes = [
    {
      number: "90%",
      label: "Improved security coverage across centralized systems"
    },
    {
      number: "24/7",
      label: "Continuous SOC monitoring for banking-grade security"
    },
    {
      number: "<15m",
      label: "Average incident response time to critical events"
    },
    {
      number: "3x",
      label: "Client growth in security maturity and readiness"
    }
  ];
