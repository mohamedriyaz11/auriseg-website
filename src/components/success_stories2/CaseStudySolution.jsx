  ...
  const challenges = [
    {
      ...
      description: "Identifies vulnerabilities and misconfigurations across infrastructure through scanning and testing to reduce risk exposure."
    },
    {
      icon: "/images/success-stories/icons/Icon copy.png",
      title: "IT Operational Control Assessment",
      description: "Evaluates key IT processes like access, change, and incident management to ensure secure and efficient operations."
    },
    {
      icon: "/images/success-stories/icons/Icon copy 2.png",
      title: "Security Management Framework Assessment",
      description: "Assesses security governance, policies, and risk management alignment with business and industry standards."
    },
    {
      icon: "/images/success-stories/icons/Icon copy 3.png",
      title: "Compliance Framework Assessment",
      description: "Reviews adherence to regulatory and industry standards, identifying gaps and supporting audit readiness."
    }
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              The Gap Assessment exercise is based on ISO27001 standards and on the security governance mechanisms of banks.
            </p>
          </div>
