  ...
  const challenges = [
    {
      ...
      description: "Bank-led acquisitions create a multi-layered environment where conflicting priorities complicate alignment"
    },
    {
      icon: "/images/success-stories/icons/icon-alert.png",
      title: "Policy and Process Misalignment",
      description: "Gap assessments are tricky across the combined organisation because of differences in governance."
    },
    {
      icon: "/images/success-stories/icons/icon-soc.png",
      title: "Diverse Technology and Organizational Structures",
      description: "Different IT set-ups, tools, designs and workflows make it hard to integrate and define clear roles."
    },
    {
      icon: "/images/success-stories/icons/icon-hiring.png",
      title: "Aligning IT for Future Transformation",
      description: "IT transformation requires coordinated engagement between IT organisations to identify common goals for the future."
    }
  ];
