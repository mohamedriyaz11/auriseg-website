...
const CaseStudyImplementation = () => {
  const steps = [
    {
      title: '1.  Security Posture Analysis',
      description: 'Assess strengths, weaknesses, and overall security visibility',
      icon: '/images/success-stories/icons/connect-systems.png',
    },
    {
      title: '2.  ISO 27001 Gap Assessment',
      description: 'Identify gaps against ISO 27001 and BS7799',
      icon: '/images/success-stories/icons/deploy-monitoring.png',
    },
    {
      title: '3.  Risk-Based Framework Adoption',
      description: 'Implement FMEA-driven risk assessment and prioritization',
      icon: '/images/success-stories/icons/activate-rules.png',
    },
    {
      title: '4.  Roadmap Development',
      description: 'Define actionable plan for target security posture',
