    ...
    [
      {
        ...
        description: "Review networking and security device configs in the central hosting zone."
      },
      {
        icon: "/images/success-stories/icons/Icon copy.png",
        title: "Infrastructure & Traffic Monitoring",
        description: "Monitor and analyse internal traffic patterns at the secure zone."
      },
      {
        icon: "/images/success-stories/icons/Icon copy 2.png",
        title: "Firewall Posture Evaluation",
        description: "Evaluate firewall rules and posture for major network aggregation sites."
      },
      {
        icon: "/images/success-stories/icons/Icon copy 3.png",
        title: "Vulnerability Assessment",
        description: "Perform vulnerability scanning and validation for central hosting systems."
      }
    ];
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Auriseg delivered a four‑phase engagement tailored to remote execution and complex, distributed infrastructure.
            </p>
          </div>
