...
const ALL_CARDS = [
  ...
  { id: 2, category: 'CATEGORY', tag: 'MODERN  INFRASTRUCTURE', title: 'Transforming Financial Security Through Strategic Risk Alignment', desc: 'Empowering financial organizations with comprehensive security assessments, risk-driven strategies, and compliance frameworks to build resilient digital operations.', service: 'Security Testing & Assurance', industry: 'Financial Services', img: '/images/success-stories/blog/post-2.jpg' },
  { id: 3, category: 'CATEGORY', tag: 'MODERN  INFRASTRUCTURE', title: 'Securing Global Operations Through Advanced Threat Assessment', desc: 'Safeguarding global logistics infrastructure through advanced penetration testing, vulnerability detection, and proactive security risk management.', service: 'GRC and Compliance', industry: 'Healthcare', img: '/images/success-stories/blog/post-1.jpg' },
  { id: 4, category: 'CATEGORY', tag: 'MODERN  INFRASTRUCTURE', title: 'Strengthening Telecom Security Across Critical Digital Networks', desc: 'Enhancing telecom infrastructure protection through advanced security assessments, risk analysis, and strategic vulnerability remediation.', service: 'Advisory and Enablement', industry: 'Government & Critical Infrastructure', img: '/images/success-stories/blog/post-2.jpg' },
  { id: 5, category: 'CATEGORY', tag: 'MODERN  INFRASTRUCTURE', title: 'Securing Global Logistics Through Intelligent Network Protection', desc: 'Strengthening global logistics infrastructure through advanced network assessments, continuous monitoring, and proactive security improvements.', service: 'For MSPs and MSSPs', industry: 'Manufacturing', img: '/images/success-stories/blog/post-1.jpg' },
