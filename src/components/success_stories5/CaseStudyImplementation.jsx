...
const CaseStudyImplementation = () => {
  const steps =
    [
      {
        title: "1. Remote Scoping & Access Setup",
        description: "Establish secure access channels and testing windows.",
        icon: "/images/success-stories/icons/connect-systems.png",
      },
      {
        title: "2. Config Review & Baseline Mapping",
        description: "Document device configurations and baseline security posture.",
        icon: "/images/success-stories/icons/deploy-monitoring.png",
      },
      {
        title: "3. Continuous Traffic Monitoring",
        description: "Capture traffic snapshots to identify anomalous flows.",
        icon: "/images/success-stories/icons/activate-rules.png",
      },
      {
        title: "4. Vulnerability Validation & Prioritisation",
        description: "Scan, verify, and rank findings for remediation.",
