...
const CaseStudyOutcome = () => {
  const outcomes =
    [
      {
        number: "90%",
        label: "Vulnerabilities identified in central hosting devices"
      },
      {
        number: "24/7",
        label: "Monitor traffic for anomalies"
      },
      {
        number: "<15m",
        label: "Mean time to respond for critical incidents"
      },
      {
        number: "3x",
        label: "Less noise after tuning and hardening"
      }
    ];
