    ...
    const cards = [
        {
            ...
            description: "Our senior analysts and consultants work shoulder-to-shoulder with your team on active client engagements. You lead the relationship; we bring the technical depth. Clients see a unified, expert operation."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "White-Label Delivery",
            description: "Auriseg operates entirely under your brand. Reports, portals, and client communications carry your identity — your clients see your team, backed by enterprise-grade security capability they'd never suspect came from a partner."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Engagement-Specific Support",
            description: "From VAPT to SOC coverage to compliance reviews, we plug into specific engagements where your team needs specialist backup — without disrupting your existing workflows or client relationships."
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Transform the way you deliver security
                        </h2>
                        ...
                        >
                            Every co-delivery engagement gives your team immediate access to the specialist security execution you need, delivered jointly or fully under your brand, without adding headcount or stretching your existing team.
                        </p>
