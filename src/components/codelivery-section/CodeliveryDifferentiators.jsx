    ...
    const features = [
        {
            ...
            description: "Every deliverable, portal, and client-facing document carries your brand. Auriseg works in the background — your clients never know we're there, unless you want them to."
        },
        {
            title: "ransparent, Margin-Friendly Pricing",
            description: "Per-engagement pricing you can mark up cleanly. No ambiguous fees, no scope creep surprises — just predictable costs that protect your margins."
        },
        {
            title: "Direct Access to Senior Specialists",
            description: "Skip the ticket queues. Co-delivery partners get direct access to Tier 2 and Tier 3 analysts and consultants from day one — not after an escalation chain."
        },
        {
            title: "Dedicated Partner Onboarding",
            description: "A named Auriseg partner manager owns your setup from day one — aligning on delivery standards, brand guidelines, reporting templates, and client handoff processes before your first joint engagement goes live."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for MSPs. Proven in Production.
                        </h2>
