        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/co-delivery/Co-delivery and Enablement Support.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px', width: '100%' }}>
                        <div className="max-w-[900px]">
                            ...
                            <div className="mb-8">
                                ...
                                >
                                    ...
                                    >
                                        Co-delivery and Enablement Support
                                    </span>
                                </div>
                            </div>
                            ...
                            >
                                Deliver More. Win More. <br />With Auriseg
                                <span style={{ color: '#FF5536' }}> Behind You. </span>
                            </h1>
                            ...
                            >
                                Auriseg partners with MSPs and enterprise security teams to co-deliver specialist security services — under your brand, at your pace. You own the client relationship. We bring the depth, the talent, and the delivery infrastructure to back it up.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                >
                                    ...
                                    >
                                        Start Co-Delivering Today →
                                    </span>
                                </Link>

                                <button
                                    onClick={() => {
                                        const el = document.getElementById('codelivery-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="text-center mb-4 w-full">
                            ...
                            >
                                Deliver More. Win More. With Auriseg
                            </h1>
                            <h1
                                style={{
                                    fontFamily: "'Cabinet Grotesk', sans-serif",
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('codelivery-process-timeline-mobile') || document.getElementById('codelivery-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
