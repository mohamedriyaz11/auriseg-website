...
const stats = [
  { number: '72', subNumber: 'Hours', description: 'White-Label Ready & Fully Operational  ' },
  { number: '150+', description: 'Active MSP & Enterprise Co-Delivery Partners ' },
  { number: '95%', description: 'Critical Findings Closed Within 30 Days ' },
  { number: '99.98%', description: 'SLA Adherence Across All Engagements ' },
];
