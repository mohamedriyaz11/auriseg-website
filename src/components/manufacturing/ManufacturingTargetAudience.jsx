  ...
  const audiences = [
    {
      ...
      title: "Defense & Aerospace Manufacturers",
      description: "Multi-site OT environments handling ITAR requirements at every layer. Auriseg scales security operations without adding headcount or slowing production."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-physician-groups.jpg",
      title: "Discrete & Process Manufacturers",
      description: "Lean IT teams managing ERP systems, SCADA networks, and connected machinery — with no dedicated security staff. Auriseg acts as your full-service OT/IT security department."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-ambulatory.jpg",
      title: "Industrial Technology & IoT Vendors",
      description: "Platforms integrated with factory floors must meet NIST, SOC 2 and customer security requirements. Auriseg integrates compliance and security controls."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-digital-health.jpg",
      title: "Food, Pharma & Regulated Manufacturers",
      description: "Auriseg ensures data protection for FDA, 21 CFR Part 11, GMP and supply chain integrity requirements."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Complete Protection for Industrial Systems
            </h2>
