...
const IndustriesStats = () => {
  const stats = [
    {
      value: "$4.47M",
      description: "Average cost of a manufacturing data breach  sector rank rising every year as OT environments expand.",
    },
    {
      value: "71%",
      description: "Of ransomware-hit manufacturers reported complete production line shutdowns, halting shipments and supply chains.",
    },
    {
      value: "22 days",
      description: "Average OT system downtime following an active cyberattack, a delay measured in lost contracts.",
    }
  ];
