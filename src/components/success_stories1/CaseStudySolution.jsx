  ...
  const challenges = [
    {
      ...
      title: "White-Label SOC Deployment",
      description: "Instant access to enterprise-grade SOC infrastructure under SecureEdge's brand."
    },
    {
      icon: "/images/success-stories/icons/Icon copy.png",
      title: "AI-Driven Alert Triage",
      description: "Machine learning algorithms automatically classify and prioritize security alerts."
    },
    {
      icon: "/images/success-stories/icons/Icon copy 2.png",
      title: "SIEM Integration",
      description: "Seamless integration with existing security tools and client environments."
    },
    {
      icon: "/images/success-stories/icons/Icon copy 3.png",
      title: "24/7 Expert Team",
      description: "Access to Auriseg's certified security analysts without hiring overhead."
    }
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              A comprehensive white-label SOC platform that enabled SecureEdge to scale
              security operations instantly.
            </p>
          </div>
