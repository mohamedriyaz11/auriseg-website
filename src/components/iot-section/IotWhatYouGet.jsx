    ...
    const cards = [
        {
            ...
            title: "OT/IoT Security Testing",
            description: "Auriseg evaluates your OT, IoT, and IIoT environments for insecure device configurations, weak protocols, unsegmented networks, remote access gaps, and exploitable pathways between IT, OT, and vehicle systems."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Automotive Cybersecurity Assurance",
            description: "Auriseg validates in-vehicle networks, ECUs, telematics, over-the-air update paths, and backend automotive services for cybersecurity weaknesses across the full vehicle lifecycle."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "OT/IoT Red Team Validation",
            description: "Security-led testing simulates real-world adversarial behavior against industrial control systems, smart facilities, and connected vehicle ecosystems."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter OT/IoT Security. Stronger Operational Resilience.
                        </h2>
