...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Security-First OT/IoT & Automotive Testing",
            description: "The focus is on real-world attack paths across OT networks, IoT devices, and in-vehicle systems, not just checkbox compliance."
        },
        {
            title: "Deployment- and Operations-Focused Guidance",
            description: "Findings are tied to rollout decisions, engineering changes, maintenance windows, and safety considerations for factories, smart infrastructure, and vehicles."
        },
        {
            title: "Actionable Remediation for Engineers and Operators",
            description: "Every issue includes clear priority, potential operational impact, and pragmatic next steps aligned to OT constraints and automotive development practices."
        },
        {
            title: "Built for Modern OT/IoT & Automotive Stacks",
            description: "Supports ICS/SCADA, PLCs, smart sensors, gateways, vehicle ECUs, telematics, and cloud backends that tie plants and fleets together."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Defense for Connected Operations and Vehicles
                        </h2>
