...
const ThreatIntegrations = () => {
    const integrations = {
        siem: ['OpenAI', 'Azure OpenAI', 'AWS Bedrock', 'Google Vertex AI', 'Hugging Face'],
        edr: ['GitHub', 'GitLab', 'Jenkins', 'Azure DevOps', 'Bitbucket'],
        firewall: ['AWS', 'Azure', 'Google Cloud', 'Kubernetes', 'Docker'],
        cloud: ['SIEM', 'EDR/XDR', 'SAST', 'DAST', 'CSPM', 'IAM', 'secrets management']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Plug Into Your AI Stack and <br />Secure It End to End.
                            </h2>
                            ...
                            >
                                Auriseg works across the tools and platforms you already use, no rip-and-replace required.
                            </p>
                        </div>
            ...
            >
                <div className="w-full px-4">
                    <div className="max-w-[342px] mx-auto">
                        ...
                        >
                            Plug Into Your AI Stack and Secure It End to End.
                        </h2>
