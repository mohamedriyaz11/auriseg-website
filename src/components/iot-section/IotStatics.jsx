...
const stats = [
  { number: '1000+', subNumber: '', description: 'OT/IoT Assets Tested Across Critical Infrastructure' },
  { number: '97%', description: 'Critical Vulnerability Detection Rate Across Engagements' },
  { number: '48-Hrs', description: 'Turnaround on Initial Findings Report' },
  { number: '100%', description: 'Protocol Coverage — Modbus, CAN Bus, MQTT, CoAP & Beyond ' },
];
