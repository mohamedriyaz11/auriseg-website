    ...
    const models = [
        {
            ...
            title: "IncidenCo-Monitored Operationst Response",
            description: "Your team keeps control while Auriseg adds monitoring depth, alert review, and escalation support across critical systems"
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed Monitoring",
            description: "Auriseg owns monitoring, triage, analysis, and reporting, giving your team more time to focus on remediation and security strategy"
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Monitoring Augmentation",
            description: "Add Auriseg expertise where you need it most, including after-hours coverage, overflow handling, and specialized threat support"
        }
    ];
