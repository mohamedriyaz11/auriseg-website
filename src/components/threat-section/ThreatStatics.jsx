...
const stats = [
    { number: '24/7', subNumber: '365', description: 'Monitoring Coverage' },
    { number: '<15m', description: 'Real-Time Threat Detection' },
    { number: '90%', description: 'Intelligence-Driven Prioritization' },
    { number: '100%', description: 'Continuous Visibility Across the Attack Surface' },
];
