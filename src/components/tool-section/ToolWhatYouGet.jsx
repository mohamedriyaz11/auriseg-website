    ...
    const cards = [
        {
            ...
            description: "Auriseg reviews your current stack, identifies functional gaps, and evaluates where new tools can improve coverage, visibility, or efficiency. The focus is on fit, overlap, and business value."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Vendor Selection",
            description: "Each option is compared against your requirements, operating model, budget, integration needs, and long-term security goals. Auriseg helps narrow the field and support a practical decision."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Implementation Planning",
            description: "You receive a clear rollout plan covering integration, configuration, testing, stakeholder alignment, and operational handoff. The goal is to make adoption smoother and avoid implementation surprises."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Evaluated. Selected. Deployed With Confidence.
                        </h2>
                        ...
                        >
                            Every engagement includes tool assessment, selection support, and implementation planning — designed to help organizations avoid tool sprawl, reduce procurement mistakes, and deploy security technology with confidence.
                        </p>
