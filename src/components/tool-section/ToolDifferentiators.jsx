...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Requirements-Driven Selection",
            description: "Auriseg helps anchor tool decisions in real needs instead of vendor marketing or feature overload."
        },
        {
            title: "Implementation That Matches Reality",
            description: "Recommendations consider staffing, processes, integrations, and operational constraints."
        },
        {
            title: "Reduced Overlap and Tool Sprawl",
            description: "The process focuses on choosing tools that complement the existing stack rather than adding unnecessary complexity."
        },
        {
            title: "Better Adoption After Purchase",
            description: "Planning includes rollout, handoff, and optimization so tools are actually used effectively after deployment."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Value for Modern Security Stacks
                        </h2>
