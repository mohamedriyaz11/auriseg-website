    ...
    const models = [
        {
            ...
            title: "Tool Selection Advisory",
            description: "A focused engagement to compare security tools, validate requirements, and support vendor shortlisting."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Implementation Planning and Support",
            description: "Structured guidance for deployment design, integration sequencing, testing, and go-live readiness."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Post-Deployment Optimization",
            description: "Support after rollout to tune configurations, improve adoption, and ensure the tool is delivering expected value."
        }
    ];
        ...
        <>
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    ...
                    {/* Built for How You Buy and Deploy - Heading */}
                    <h2
                    ...
                    >
                        Built for How You Buy and Deploy
                    </h2>
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for How You Buy and Deploy - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
