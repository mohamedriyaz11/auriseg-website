...
const stats = [
  { number: '200+', subNumber: '', description: 'Security Tools Evaluated Across Categories' },
  { number: '72-Hrs', description: 'Vendor Shortlist Delivered Post-Assessment' },
  { number: '95%', description: 'Deployments Go Live On Schedule' },
  { number: '1', description: 'Named Engineer. End-to-End Ownership. ' },
];
