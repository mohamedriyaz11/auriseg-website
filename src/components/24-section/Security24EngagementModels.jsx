    ...
    const models = [
        {
            ...
            title: "Co-Monitored Security Operations",
            description: "Your internal team stays in control while Auriseg adds round-the-clock monitoring, alert review, and escalation support in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed Monitoring",
            description: "Offload continuous monitoring entirely. Auriseg handles detection, triage, investigation, and reporting so your team can focus on remediation and strategy."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Monitoring Augmentation",
            description: "Add coverage where you need it most, including after-hours monitoring, alert overflow, and specialized threat analysis support."
        }
    ];
