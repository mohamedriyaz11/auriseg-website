    ...
    const cards = [
        {
            ...
            description: "Auriseg monitors your environment around the clock across endpoints, networks, cloud workloads, and critical systems. Every relevant signal is reviewed to surface suspicious activity before it becomes a business impact."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Threat Investigation",
            description: "Every high-priority alert triggers structured investigation. Auriseg analysts validate indicators, trace attack activity, separate false positives from real threats, and deliver clear findings your team can act on."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Rapid Incident Response",
            description: "When threats are confirmed, Auriseg escalates quickly with the right context, affected assets, and recommended actions. Your team gets the information needed to contain issues faster and reduce operational disruption."
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Strengthening Your Business Against Modern Threats
                        </h2>
                        ...
                        >
                            Every engagement includes continuous monitoring, threat-led analysis, and fast escalation support — built to help organizations reduce noise, improve visibility, and act on threats with confidence.
                        </p>
