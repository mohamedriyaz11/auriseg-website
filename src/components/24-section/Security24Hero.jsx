                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Watch Every Threat<br /> and Respond Before <br />
                                <span style={{ color: '#FF5536' }}>It Spreads.</span>
                            </h1>
                            ...
                            >
                                Auriseg delivers 24/7 security monitoring with continuous visibility, real-time detection, and expert-led investigation — helping your team identify, validate, and respond to threats without delay.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('security24-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('security24-process-timeline-mobile') || document.getElementById('security24-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
