...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Continuous Expert Oversight",
            description: "Security monitoring is backed by experienced analysts, not unmanaged alert streams."
        },
        {
            title: "Reduced Alert Noise",
            description: "Auriseg helps your team focus on validated threats instead of wasting time on low-value noise."
        },
        {
            title: "Faster Escalation Paths",
            description: "Critical issues move quickly from detection to investigation to action with clear escalation steps."
        },
        {
            title: "Rapid Onboarding",
            description: "From integration to live monitoring, Auriseg helps you become operational quickly with minimal friction.  "
        }
    ];
