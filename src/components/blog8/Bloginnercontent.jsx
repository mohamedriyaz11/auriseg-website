...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  "When AI Starts Hacking Your Conversations: Inside PromptSpy's AI-Powered Attacks",
  "What is PromptSpy?",
  "What are the Organizational Impacts",
  "Auriseg's Defense Strategy",
...
const SECTIONS = [
  {
    id: 's0',
    heading: "When AI Starts Hacking Your Conversations: Inside PromptSpy's AI-Powered Attacks",
    body: [
      <>
        In the rapidly evolving cybersecurity landscape, AI systems are both powerful allies and prime targets.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          PromptSpy and similar AI malware represent a dangerous new frontier of prompt-level exploits
        </span>
        {' '}that hijack Large Language Models (LLMs) to extract sensitive data, execute malicious commands,
        or spread stealthily within organisations.
        <br /><br />

        These attacks bypass traditional defences, turning AI tools against their users.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'What is PromptSpy?',
    hasTable: true,
    body: [
      <>
        PromptSpy is an advanced AI malware strain that embeds itself in LLM prompts.
        <br /><br />

        Attackers craft seemingly innocent inputs laced with
        <span style={{ color: '#FF5536' }}>
          {' '}hidden instructions, jailbreak payloads, data exfiltration triggers,
          or self-propagating code
        </span>
        {' '}that compel AI models to leak training data, user credentials, or internal documents.
        <br /><br />

        Unlike classic malware, it operates at the "prompt level,"
        exploiting the black-box nature of AI inference without needing code-level access.
        <br /><br />

        For example, a single poisoned prompt in a customer service chatbot could cascade:
        the AI responds by emailing proprietary code to an attacker-controlled address,
        all while appearing normal to end-users.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'What are the Organizational Impacts',
    body: [
      <>
        These exploits hit enterprises hard, amplifying risks in AI-driven workflows:
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Data Breaches at Scale:</span>
        {' '}Prompt injections can force AI to dump customer PII, API keys,
        or trade secrets embedded in conversation history that impact compliance with DPDP, GDPR, and ISO standards.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Operational Disruption:</span>
        {' '}In SOCs or MSSPs, compromised AI triage tools might misclassify threats,
        approve fraudulent logins, or generate false alerts, eroding trust in automation.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Insider Threat Amplification:</span>
        {' '}Employees unwittingly propagate malware via shared prompts in tools like ChatGPT or custom copilots,
        turning collaborative AI into a breach vector.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Financial Toll:</span>
        {' '}Verizon's DBIR notes phishing (a common delivery method) in 90% of breaches;
        AI malware escalates this, with cleanup costs soaring due to model retraining and audit failures.
        <br /><br />

        Real-world fallout? A mid-sized firm could face millions in fines,
        lost IP, and reputational damage from one overlooked prompt attack.
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: "Auriseg's Defense Strategy",
    hasChecklist: true,
    body: [
      <>
        At Auriseg, we specialise in fortifying AI against these prompt-level threats.
        Our managed security services deliver:
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>AI Threat Monitoring:</span>
        {' '}Real-time prompt scanning in SOC operations detects injections using behavioural AI models trained on emerging exploits like PromptSpy.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Hardened LLM Deployments:</span>
        {' '}Custom guardrails, sandboxed inference, and output filtering prevent data leaks integrated with your existing MSSP stack.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Awareness & Simulations:</span>
        {' '}Tailored phishing drills (including AI variants) and training reduce human error,
        proven to cut click rates by 40%+.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Compliance Assurance:</span>
        {' '}Full audits for NESA, DPDP, and GDPR,
        ensuring AI tools meet regulatory demands without slowing innovation.
        <br /><br />

        We've secured AI pipelines, preventing breaches before they cascade.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'Ready to Secure Your AI Future?',
    body: [
      <>
        Don't let prompt-level exploits undermine your operations.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          Contact Auriseg today to assess your vulnerabilities!
        </span>
      </>
    ],
  },
