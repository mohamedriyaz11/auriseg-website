  ...
  const caseStudies = [
    {
      ...
      challenge: [
        ...
        "Staff credentials exposed in a prior dark web data leak — undetected for 9 months",
        "No incident response plan or breach notification protocol in place"
      ],
      solution: [
        "Deployed Auriseg IoMT discovery and segmentation across all 14 sites in 3 weeks",
        "Executed emergency BAA compliance reviews and vendor risk remediations",
        "Launched 24/7 SOC monitoring with identity threat detection enabled on Day 1",
        "Delivered HIPAA-aligned IR playbook and conducted full-staff tabletop Exercise"
      ],
      impact: [
        { value: "100%", label: "IoMT devices discovered, classified, and segmented before audit date" },
        { value: "3", label: "critical vendor violations remediated — audit passed with zero findings" },
        { value: "4-Hrs", label: "MTTR reduced from 22 days to 4 hours post-SOC deployment" },
        { value: "$2.1M", label: "potential HIPAA fines avoided based on violation categories identified" }
      ],
