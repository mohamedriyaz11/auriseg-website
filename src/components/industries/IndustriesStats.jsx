...
const IndustriesStats = () => {
  const stats = [
    {
      value: "$10.9M",
      description: "Average healthcare data breach cost, the highest of any sector for 13 consecutive years.",
    },
    {
      value: "67%",
      description: "Of ransomware-hit healthcare organizations reported complete disruption to patient care delivery.",
    },
    {
      value: "21 min",
      description: "Average ambulance diversion time during an active ransomware attack, a delay measured in lives.",
    }
  ];
