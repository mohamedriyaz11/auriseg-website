  ...
  const audiences = [
    {
      ...
      description: "Multi-site environments with complex EHR integrations, federated IT teams, and regulatory scrutiny at every layer. Auriseg scales security operations without adding headcount."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-physician-groups.jpg",
      title: "Physician Groups & Ambulatory Clinics",
      description: "Lean IT teams managing clinical data, billing systems, and patient portals with no dedicated security staff. Auriseg acts as your full-service security department."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-ambulatory.jpg",
      title: "Digital Health & HealthTech Companies",
      description: "SaaS platforms processing PHI must meet HIPAA, SOC 2, and enterprise customer security requirements. Auriseg embeds compliance and security controls from product architecture through deployment."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-digital-health.jpg",
      title: "Specialty & Behavioral Health Providers",
      description: "Behavioral health records carry heightened sensitivity and targeted theft risk. Auriseg applies precision data protection controls tailored to your patient population and regulatory obligations"
    }
  ];
