...
const IndustriesTestimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      id: 2,
      image: "/images/industries_navbar/healthcare/testimonial-1.jpg",
      quote: "Implementing their customised framework gave us the confidence that oursensitive patient information is safe and that we’re consistently meeting compliance standards.",
      name: "",
      title: "Head of Operations, AIIMS",
