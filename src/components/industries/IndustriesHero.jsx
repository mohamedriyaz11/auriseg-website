        ...
        <div className="relative z-10 w-full h-full flex items-start pt-32">
          <div className="w-full pr-8 md:pr-12 lg:pr-16 xl:pr-20" style={{ paddingLeft: '2cm' }}>
            <div className="max-w-[800px]">
              ...
              >
                A Compromised Network Is a <br />Compromised Patient.
              </h1>
              ...
              >
                Auriseg secures healthcare organizations against ransomware,
                PHI theft, and regulatory failure without disrupting clinical operations.
                Purpose-built for the care continuum. Deployed with precision.
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  onClick={() => {
                    const el = document.getElementById('industries-compliance');
                    if (el) {
                      const offset = 100;
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-start pt-6 px-6">
          <div className="text-center">
            ...
            <div className="flex flex-col gap-3 items-center">
              ...
              <button
                onClick={() => {
                  const el = document.getElementById('industries-compliance-mobile') || document.getElementById('industries-compliance');
                  if (el) {
                    const offset = 100;
                    const top = el.getBoundingClientRect().top + window.scrollY - offset;
                    window.scrollTo({ top, behavior: 'smooth' });
