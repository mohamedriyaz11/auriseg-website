...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Analyst-Led Threat Validation",
            description: "Auriseg helps eliminate noise by validating threats before escalation, so your team focuses on what actually matters."
        },
        {
            title: "Faster Escalation Paths",
            description: "Critical incidents move quickly from detection to response with clear communication and actionable context."
        },
        {
            title: "Operationally Aligned Response",
            description: "Auriseg aligns investigations and response workflows to your existing environment, tools, and escalation processes."
        },
        {
            title: "Rapid Onboarding",
            description: "From integration to detection coverage, Auriseg helps you get operational quickly with structured onboarding and minimal friction."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Visibility. Proven Under Pressure.
                        </h2>
