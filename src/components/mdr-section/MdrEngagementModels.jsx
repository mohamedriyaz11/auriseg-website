    ...
    const models = [
        {
            ...
            title: "Co-Managed MDR",
            description: "Your internal team keeps strategic control while Auriseg adds always-on detection, investigation, and response support in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed MDR",
            description: "Auriseg owns detection, triage, investigation, response coordination, and reporting — freeing your team to focus on risk reduction and business priorities."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Monitoring Augmentation",
            description: "Strengthen your current security operations with expert support for after-hours coverage, alert overflow, and specialized threat investigation."
        }
    ];
