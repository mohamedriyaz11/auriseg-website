...
const stats = [
  { number: '24/7', subNumber: '365', description: 'Threat Monitoring' },
  { number: '<15m', description: 'Rapid Alert Triage' },
  { number: '90%', description: 'Faster Threat Containment' },
  { number: '100%', description: 'Full Visibility. Faster Response.' },
];
