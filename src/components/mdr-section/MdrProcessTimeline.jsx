...
const stats = [
  { value: '1000+', label: 'Alerts Investigated\nMonthly' },
  { value: '60%', label: 'Faster Response to\nConfirmed Threats' },
  { value: '80%', label: 'Reduced Alert Fatigue\nfor Internal Teams' },
  { value: '97%', label: 'Continuous Detection with\nResponse Discipline' },
];
  ...
  return (
    <>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="mdr-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
