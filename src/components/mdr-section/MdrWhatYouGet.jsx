    ...
    const cards = [
        {
            ...
            description: "Auriseg continuously monitors your telemetry across endpoints, networks, cloud platforms, and security tools to identify suspicious activity in real time. High-risk behaviors are surfaced early so your team can act before threats escalate."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Threat Investigation",
            description: "Every validated alert is investigated by Auriseg analysts to determine scope, intent, and business impact. Instead of raw events, your team receives verified findings, attack context, and response-ready intelligence."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Managed Response",
            description: "When incidents are confirmed, Auriseg supports containment and remediation with clear escalation, response coordination, and actionable guidance. This helps reduce dwell time and improves your ability to contain threats quickly."
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Security Designed to Stay Ahead
                        </h2>
                        ...
                        >
                            Every MDR engagement includes continuous monitoring, expert-led threat investigation, and guided incident response — designed to reduce alert fatigue and improve security outcomes across your environment.
                        </p>
