  ...
  const services = [
    {
      ...
      description: 'Systematic scanning and analysis to identify, classify, and prioritize security weaknesses across your infrastructure.',
    ...
    },
    {
      ...
      description: 'Adversarial simulation of real attacks to expose exploitable paths before malicious actors find them.',
    ...
    },
    {
      ...
      description: 'Deep static and dynamic analysis of iOS and Android apps to uncover data leakage and logic flaws.',
    ...
    },
    {
      ...
      description: 'Comprehensive review of cloud configurations, IAM policies, and architecture against security best practices.',
      link: '/services/cloud-security-audit',
      linkText: 'Explore →',
      icon: '/icons/msp/whitelabel-icon.png'
    },
    {
      title: 'Social Engineering and Phishing Simulations',
      description: 'Realistic phishing and pretexting campaigns that measure and build employee security awareness.',
    ...
    },
    {
      ...
      description: 'Manual and automated source code analysis to detect injection flaws, logic errors, and insecure patterns.',
      link: '/services/source-code-review',
      linkText: 'Explore →',
      icon: '/icons/msp/whitelabel-security-icon.png'
    },
    {
      title: 'AI Security Testing and Deployment',
      description: 'End-to-end security validation of AI pipelines ensuring safe, compliant, and robust production deployment.',
      link: '/services/ai-security',
      linkText: 'Explore →',
      icon: '/icons/msp/soc-icon.png'
    },
    {
      title: 'OT/IoT security and automotive security',
      description: 'Protects connected devices, industrial systems, and smart vehicles from cyber threats, ensuring secure, safe, and reliable operations.',
      link: '/services/ot-iot-security',
      linkText: 'Explore →',
      icon: '/icons/msp/threat-icon.png'
    },
