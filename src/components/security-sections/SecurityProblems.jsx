  ...
  const problems = [
    {
      ...
      description: 'Undetected flaws in systems silently expose organizations to catastrophic breach risk.',
      icon: '/icons/msp/soc-cost-icon.png'
    },
    {
      title: 'Compliance Blind Spots',
      description: 'Checkbox security audits miss real-world attack paths that regulators never test for.',
      icon: '/icons/msp/analyst-shortage-icon.png'
    },
    {
      title: 'Untested AI Systems',
      description: 'New AI deployments introduce novel attack surfaces that traditional tools cannot assess.',
      icon: '/icons/msp/coverage-icon.png'
    },
    {
      title: 'Human Attack Surface',
      description: 'Employees remain the most exploited entry point, yet receive no realistic threat simulation.',
    ...
    <section className="w-full bg-dark py-16 md:py-20">
      ...
      >
        ...
        <div className="mb-12 md:mb-16">
          ...
          >
            Security gaps destroy <span style={{ color: '#FE5538' }}>enterprise value </span>
          </h2>
        </div>
      ...
      <div className="md:hidden" style={{ padding: '0 20px' }}>
        ...
        <h2 style={{
          ...
          Security gaps destroy enterprise value
        </h2>
