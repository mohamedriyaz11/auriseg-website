  ...
  const steps = [
    {
      ...
      title: "",
      description: "We scope your environment, define objectives, and align on rules of engagement and timelines."
    },
    {
      label: "Testing",
      icon: "/icons/how-it-works/2.png",
      title: "",
      description: "Certified testers execute the agreed methodology with minimal disruption to your operations."
    },
    {
      label: "Reporting",
      icon: "/icons/how-it-works/3.png",
      title: "",
      description: "You receive a prioritized findings report with business-context risk ratings and remediation steps."
    },
    {
      label: "Remediation",
      icon: "/icons/how-it-works/4.png",
      title: "",
      description: "We validate your fixes with a complimentary retest and issue a final assurance certificate."
    }
  ];
