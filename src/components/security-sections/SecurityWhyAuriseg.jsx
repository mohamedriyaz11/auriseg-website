...
const IotDifferentiators = () => {
  ...
  const features = [
    {
      title: "Certified, Practitioner-Led Teams",
      description: "Every engagement is led by OSCP, CEH, and CREST-certified testers with active red team experience."
    },
    {
      title: "Actionable Reports",
      description: "Findings are ranked by exploitability and business impact with clear step-by-step remediation plans."
    },
    {
      title: "AI-Era Threat Coverage",
      description: "We test AI and GenAI systems using purpose-built methodologies no legacy firm currently offers."
    },
    {
      title: "Post-Engagement Remediation Support",
      description: "Our team stays engaged after delivery to verify fixes and provide retest validation at no extra cost."
    }
  ];
