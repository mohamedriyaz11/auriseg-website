...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Highly Realistic Scenarios",
            description: "Campaigns are built to reflect current attacker behavior, improving test relevance and reducing false comfort."
        },
        {
            title: "Security-First Approach",
            description: "Exercises are designed to validate controls and awareness without creating unnecessary disruption or fatigue."
        },
        {
            title: "Actionable Reporting",
            description: "Findings are translated into clear remediation guidance, making results useful for security leaders, training teams, and auditors."
        },
        {
            title: "Tailored to Business Risk",
            description: "Simulations can be aligned to departments, roles, geographies, or threat profiles to mirror your real exposure."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Assurance. Proven in Practice.
                        </h2>
