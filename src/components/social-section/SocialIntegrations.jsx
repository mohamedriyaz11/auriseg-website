...
const ThreatIntegrations = () => {
    const integrations = {
        siem: ['Microsoft Defender for Office 365', 'Proofpoint', 'Mimecast'],
        edr: ['Microsoft Entra ID', 'Okta', 'Ping Identity'],
        firewall: ['Microsoft Teams', 'Slack', 'Google Workspace'],
        cloud: ['KnowBe4', 'Proofpoint Security Awareness', 'Cofense'],
        app: ['Microsoft Sentinel', 'Splunk', 'IBM QRadar', 'Elastic']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg aligns with your existing security stack and reporting workflows to support testing, visibility, and follow-up without disruption.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            {/* SIEM / Reporting Row */}
                            <div className="flex border-t border-[#ADADAD]">
                                <div
                                    className="flex-shrink-0"
                                    style={{
                                        width: '266px',
