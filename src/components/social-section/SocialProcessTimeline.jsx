...
const stats = [
  { value: '100+', label: 'simulation campaigns\ndelivered' },
  { value: '75%', label: 'average increase in\nreport rate' },
  { value: '150+', label: 'Role-based risk insights across departments' },
  { value: '99.9%', label: 'Actionable findings for assurance reviews' },
];

const steps = [
  {
    title: '1. Scoping Call',
    description: 'Define goals, target groups, risk areas, and testing boundaries.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Scenario Design',
    description: 'Build tailored phishing and social engineering lures based on your environment.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Approval & Controls ',
    description: 'Confirm scope, compliance requirements, and escalation handling.',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Simulation Launch ',
    description: 'Deploy campaigns and monitor user responses in real time.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Reporting & Remediation ',
    description: 'Deliver insights, trends, and recommended next steps.',
    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Auriseg’s structured rollout is fast and controlled, moving from planning to live simulations in under two weeks
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="social-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
