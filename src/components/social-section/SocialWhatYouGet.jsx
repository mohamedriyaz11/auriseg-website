    ...
    const cards = [
        {
            ...
            description: "Auriseg runs realistic email-based phishing campaigns tailored to your organization’s users, roles, and risk profile. Each simulation helps identify who clicks, who reports, and where awareness gaps remain."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Social Engineering Scenarios",
            description: "We design targeted impersonation exercises across email, chat, phone, and web workflows to test how employees respond to deception attempts. These scenarios help validate trust boundaries, approval habits, and escalation discipline."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Reporting & Remediation",
            description: "After each exercise, Auriseg delivers clear findings, risk trends, and department-level insights with recommended training actions. You get evidence-backed assurance, not generic awareness metrics."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter Cybersecurity for a More Resilient Enterprise
                        </h2>
                        ...
                        >
                            Every engagement is designed to uncover human-layer vulnerabilities through controlled simulations, actionable reporting, and guided remediation built for ongoing security assurance.
                        </p>
