...
const stats = [
  { number: '94%', subNumber: '', description: 'Cyberattacks begin with a human-layer exploit' },
  { number: '72-Hrs', description: 'Turnaround from scoping to first campaign launch' },
  { number: '3x', description: 'Faster security awareness uplift versus training-only programs' },
  { number: '100%', description: 'Findings mapped to actionable remediation steps' },
];
