  ...
  const caseStudies = [
    {
      ...
      description: "A 200-person B2B SaaS company was operating with no formal security program, an unaudited AWS environment spanning 12 production accounts, and an open SOC 2 Type II audit deadline 8 weeks away with three enterprise contracts contingent on certification.",
      challenge: [
        "No documented security policies, access controls, or incident response procedures",
        "Overprivileged IAM roles across all 12 AWS accounts including production",
        "Three former employees retained active system access undetected for 6 months",
        "No continuous monitoring, SIEM, or vulnerability management program in place"
      ],
      solution: [
        "Deployed Auriseg cloud security posture management across all 12 AWS accounts in 2 weeks",
        "Executed emergency IAM remediation and access review terminating 47 overprivileged roles",
        "Launched 24/7 SOC monitoring with identity threat detection and SIEM integration on Day 1",
        "Delivered SOC 2 Type II control environment, policies, and evidence automation within 6 weeks"
      ],
      impact: [
        {
          value: "100%",
          label: "of critical cloud misconfigurations remediated before audit date"
        },
        {
          value: "SOC 2",
          label: "Type II certification achieved zero findings, on schedule"
        },
        {
          value: "$3.2M",
          label: "ARR from three enterprise contracts closed within 90 days of certification"
        },
        {
          value: "3-Hrs",
          label: "MTTR reduced from 18 days to 3 hours post-SOC deployment"
        }
      ],
