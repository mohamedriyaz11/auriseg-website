...
const WhyAuriseg = () => {
  const features = [
    {
      title: 'Technology-Native Security Expertise',
      description: 'Our analysts hold CISSP, CISA, AWS Security Specialty, and CCSP certifications and understand the difference between a CI/CD pipeline anomaly and an active supply chain intrusion. Engineering context drives every security decision.',
      icon: '/icons/24-hours-fill.png'
    },
    {
      title: 'Compliance-First Engineering',
      description: 'Every control we deploy is mapped to SOC 2, ISO 27001, GDPR, and NIST CSF. You don’t get a generic security stack retrofitted to software companies, you get architecture built for it from day one.',
      icon: '/icons/ai.png'
    },
    {
      title: 'Zero Disruption to Engineering Velocity',
      description: 'Security that blocks deployments isn’t security, it’s a bottleneck. Auriseg deploys, monitors, and remediates without touching production pipelines, sprint cycles, or release timelines.',
      icon: '/icons/shield-line.png'
    },
    {
      title: 'Augmentation Without the Hiring Timeline',
      description: 'Auriseg security engineers will join your team quickly. You don’t need to spend months looking for a CISO. Scale up or down as your business grows.',
      ...
      <div className="container-custom px-4 sm:px-6 md:px-8 mx-auto relative z-10 pt-44 pb-12 md:py-16 lg:py-20">
        <div className="flex flex-col items-center justify-center min-h-[600px] pt-0 md:pt-30 lg:pt-52">
          ...
          <div className="mb-10 md:mb-12 text-center">
            ...
            >
              Why Technology Companies <br /> Choose Auriseg            </h2>
          </div>
