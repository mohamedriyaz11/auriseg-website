  ...
  const audiences = [
    {
      ...
      title: "SaaS & Cloud Platform Companies",
      description: "Multi-tenant cloud environments with complex API ecosystems, enterprise customer data obligations, and SOC 2 or ISO 27001 certification requirements at every sale. Auriseg scales security operations without slowing engineering velocity."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-physician-groups.jpg",
      title: "Software Development & ISV Companies",
      description: "Development teams managing source code repositories, CI/CD pipelines, and third-party integrations — with no dedicated security engineering staff. Auriseg acts as your full-service security and compliance department."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-ambulatory.jpg",
      title: "Fintech & Regulated Technology Platforms",
      description: "Technology platforms processing financial data, payments, or sensitive PII must meet PCI DSS, SOC 2, and enterprise customer security mandates. Auriseg embeds compliance and security controls from architecture through deployment."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-digital-health.jpg",
      title: "Technology Startups & Scale-Ups",
      description: "Early stage and growth stage companies facing enterprise procurement security questionnaires and investor due diligence. Auriseg builds the security program that unlocks your next deal, funding round, or market expansion."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Built for Every Layer of the Technology Ecosystem
            </h2>
