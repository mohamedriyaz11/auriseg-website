...
const IndustriesProblem = () => {
  ...
  const problems = [
    {
      title: "Ransomware Targets Development Infrastructure",
      description: "Attackers encrypt source code repositories, CI/CD pipelines, and cloud environments — halting releases and holding intellectual property as ransom. Downtime costs tech firms an average of $1.4M per incident.",
      image: "/images/industries_navbar/healthcare/problem-ransomware.jpg",
    },
    {
      title: "Software Supply Chain Attacks Multiply Risk",
      description: "A single compromised dependency, open-source package, or third-party SDK can cascade across thousands of customer environments. Supply chain attack frequency rose 245% from 2023 to 2024.",
      image: "/images/industries_navbar/healthcare/problem-iomt.jpg",
    },
    {
      title: "Regulatory Pressure Is Intensifying",
      description: "SOC 2 Type II, ISO 27001, GDPR, CCPA, and emerging SEC cyber disclosure rules now define market access for enterprise technology vendors. Non-compliance is a revenue risk, not just a legal one.",
      image: "/images/industries_navbar/healthcare/problem-regulatory.jpg",
    },
    {
      title: "Insider Threats Evade Detection",
      description: "Privileged developers, DevOps engineers, and contractors account for 34% of technology sector breaches. Without behavioral analytics and least-privilege enforcement, anomalies stay hidden until code or data is gone.",
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Why Technology Is the #1 Target for Cybercriminals
            </h2>
