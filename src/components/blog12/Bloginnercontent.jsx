...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  "Chrome Zero-Day Vulnerabilities Exploited in 2025: Key Insights",
  "2025 Zero-Day Landscape at a Glance",
...
const SECTIONS = [
  {
    id: 's0',
    heading: 'Chrome Zero-Day Vulnerabilities Exploited in 2025: Key Insights',
    body: [
      <>
        Throughout 2025, Google patched eight actively exploited zero-day vulnerabilities in the Chrome browser,
        highlighting the continued focus of sophisticated threat actors on the world’s most widely used web platform.
        <br /><br />

        All eight flaws were classified as
        <span style={{ color: '#FF5536' }}>
          {' '}high severity (average CVSS ~8.5)
        </span>
        {' '}and were added to CISA’s Known Exploited Vulnerabilities (KEV) catalog,
        confirming real-world exploitation.
        <br /><br />

        These vulnerabilities were not isolated incidents.
        They targeted core Chrome components, including the
        <span style={{ color: '#FF5536' }}>
          {' '}V8 JavaScript engine, sandbox protection mechanisms, and graphics/GPU layers,
        </span>
        {' '}components deeply embedded in everyday enterprise workflows.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: '2025 Zero-Day Landscape at a Glance',
    hasTable: true,
    image: '/images/blog/12-1.png',
    body: [
      <>
        ● 50% of vulnerabilities targeted the V8 JavaScript engine,
        reinforcing its attractiveness as a high-impact attack vector.
        <br /><br />

        ● ANGLE and GPU components accounted for two flaws,
        enabling memory corruption and sandbox escape.
        <br /><br />

        ● Additional exploits affected Chrome’s Mojo IPC framework
        and Loader policy enforcement.
        <br /><br />

        Google’s Threat Analysis Group (TAG) identified six of the eight zero-days,
        reflecting sustained nation-state and commercial surveillance activity.
        <br /><br />

        Kaspersky and Apple Security also contributed to key discoveries during the year.
        <br /><br />

        The vulnerabilities were patched steadily from March through December,
        indicating continuous exploitation attempts rather than clustered disclosures tied to audits or releases.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'Common Exploitation Techniques',
    body: [
      <>
        <span style={{ color: '#FF5536' }}>1. V8 Type Confusion</span>
        <br /><br />

        Three zero-days exploited type confusion flaws in V8,
        where incorrect assumptions during JavaScript optimization led to memory corruption
        and potential code execution.
        <br /><br />

        These attacks relied on deep knowledge of V8’s internal memory structures
        and heap manipulation techniques.

        <br /><br />

        <span style={{ color: '#FF5536' }}>2. Sandbox Escapes</span>
        <br /><br />

        Two vulnerabilities enabled attackers to break out of Chrome’s sandbox,
        allowing access to underlying system resources.
        <br /><br />

        Notably, CVE-2025-2783 was used in a real espionage campaign (Operation ForumTroll),
        demonstrating the severity of chained browser exploits.

        <br /><br />

        <span style={{ color: '#FF5536' }}>3. Out-of-Bounds Memory Access</span>
        <br /><br />

        Several flaws enabled attackers to read or write memory beyond intended boundaries,
        leading to data leakage or arbitrary code execution through controlled heap corruption.
      </>
    ],
  },
...

  {
    ...
    body: [
      <>
        Despite significant investments in browser hardening technologies such as MiraclePtr
        and enhanced sandbox isolation,
        Chrome remains a high-value target due to its ubiquity and deep integration into enterprise environments.
        <br /><br />

        Browsers now function as critical access points to:
        <br /><br />
        ...
        <span style={{ color: '#FF5536' }}>
          This makes browser exploitation a direct enterprise risk,
          not just an endpoint concern.
        </span>
      </>
    ],
  },
...

  {
    ...
    hasChecklist: true,
    image: '/images/blog/12-2.png',
    body: [
      <>
        While rapid patching remains essential,
        organizations should adopt a defense-in-depth approach, including:
        <br /><br />

        ● Browser isolation for high-risk web activity.
        <br /><br />

        ● Network-level detection of exploitation behavior.
        <br /><br />

        ● Continuous monitoring for zero-day indicators.
        <br /><br />

        The steady pace of Chrome zero-day exploitation in 2025 reinforces a clear reality:
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          Browser security is now frontline security.
        </span>
      </>
    ],
  },
    ...
    <div>
      ...
      {SECTIONS.map((sec, i) => (
        <div key={sec.id} id={sec.id}>
          ...
          {sec.image && (
            <img src={sec.image} alt="" style={{ width: '100%', height: 'auto', borderRadius: '8px', marginBottom: '24px', display: 'block' }} />
          )}
