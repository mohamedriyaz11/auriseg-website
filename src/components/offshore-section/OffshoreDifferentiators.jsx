    ...
    const features = [
        {
            ...
            description: "Full white-label infrastructure on all portals and reports, ensuring your brand stays front and center."
        },
        {
            title: "Transparent Pricing",
            description: "Per-endpoint, per-tier pricing helps you forecast costs and protect margins."
        },
        {
            title: "Analyst Escalation Path",
            description: "Get immediate access to Tier 2 and Tier 3 experts. No ticket black holes; escalate in minutes, not hours."
        },
        {
            title: "Dedicated Onboarding",
            description: "A named engineer manages your transition, getting you fully operational and battle-ready in 72 hours or less."
        }
    ];
