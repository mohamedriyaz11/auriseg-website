    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Our structured onboarding process moves fast, moving from signature to full SOC coverage in under two weeks.
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="offshore-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
