    ...
    const cards = [
        {
            ...
            title: "Continuous Offshore Monitoring",
            description: "Our global analysts monitor your environments 24/7. We triage, correlate, and escalate only the critical threats, ensuring your team never wastes time on noise."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Advanced Threat Investigation",
            description: "Every high-fidelity alert triggers a deep-dive investigation. Our analysts trace the entire attack chain and provide clear, actionable findings—no more raw data dumps."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Rapid Incident Response",
            description: "When threats are confirmed, our team executes immediate containment and coordinates full remediation, slashing your dwell time before damage occurs."
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement provides continuous offshore monitoring, expert-led investigations, and rapid, platform-native response—built to help you scale operations at a fraction of the cost.
                        </p>
