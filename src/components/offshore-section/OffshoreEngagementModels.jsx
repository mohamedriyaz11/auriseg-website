    ...
    const models = [
        {
            ...
            description: "You keep full control. Our offshore analysts act as an embedded extension, sharing workloads and escalations in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed SOC",
            description: "Offload the burden entirely. We own the detection, triage, and reporting, allowing your internal team to focus on high-level strategy."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "SOC Augmentation",
            description: "Staff the gaps. Inject our specialized offshore expertise into your existing SOC to cover after-hours, overflow, or complex niche threats on demand."
        }
    ];
        ...
        <>
            ...
            >
                <div className="w-full max-w-[1240px] mx-auto">
                    ...
                    {/* Built for the Way MSPs Work - Heading */}
                    <h2
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for the Way MSPs Work - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
