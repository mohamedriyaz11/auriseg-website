...
const stats = [
  { number: '24/7', subNumber: '365', description: 'Global Analyst Coverage' },
  { number: '<15m', description: 'Rapid Alert Triage SLA' },
  { number: '90%', description: 'Reduction in Your MTTR' },
  { number: '100%', description: 'Total Visibility. Zero Security Gaps.' },
];
