        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/offshore-teams/offshore-teams.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px', width: '100%' }}>
                        <div className="max-w-[900px]">
                            ...
                            >
                                Scale Your SOC <br />Faster with Offshore<br />
                                <span style={{ color: '#FF5536' }}>Security Specialists </span>
                            </h1>
                            ...
                            >
                                Auriseg delivers a world-class, offshore security powerhose that acts as a seamless extension of your team. With 24/7/365 elite analyst coverage and AI-driven detection, we eliminate your security gaps without the local talent drain.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('offshore-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('offshore-process-timeline-mobile') || document.getElementById('offshore-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
