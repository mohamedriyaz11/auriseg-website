    ...
    const cards = [
        {
            ...
            title: "RReadiness Assessment",
            description: "Auriseg reviews your current control environment, policies, procedures, and documentation to assess how prepared you are for upcoming audits. The focus is on surfacing issues before they become audit findings."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Gap Analysis",
            description: "Every identified gap is mapped against expected control requirements, evidence needs, and operational practices. Auriseg helps your team understand what is missing, what is weak, and what must be improved before audit time."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Remediation Planning",
            description: "You receive a structured action plan to close gaps, strengthen documentation, and improve audit confidence. The goal is not just readiness on paper, but readiness in practice."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter Readiness. Stronger Compliance.
                        </h2>
                        ...
                        >
                            Every engagement includes readiness assessment, control evaluation, and documentation support designed to help your organization identify gaps early and prepare effectively for internal and external audits.
                        </p>
