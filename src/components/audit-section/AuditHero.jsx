        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/audit-readiness/Audit Readiness.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Be Audit-Ready Before<br />
                                <span style={{ color: '#FF5536' }}>The Auditor Walks In</span>
                            </h1>
                            ...
                            >
                                Auriseg helps organizations prepare for audits with structured readiness assessments, control reviews, evidence validation, and remediation guidance so you can face compliance reviews with confidence, not last-minute chaos.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                >
                                    ...
                                    >
                                        Start Audit Readiness →
                                    </span>
                                </Link>

                                <button
                                    onClick={() => {
                                        const el = document.getElementById('audit-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('audit-process-timeline-mobile') || document.getElementById('audit-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
