...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Practical Control Validation",
            description: "Auriseg focuses on whether controls actually work in practice, not just whether they exist on paper."
        },
        {
            title: "Evidence-Focused Approach",
            description: "Readiness is aligned to what auditors will expect to review, helping teams reduce surprises during the audit process."
        },
        {
            title: "Actionable Remediation Guidance",
            description: "Findings are translated into clear next steps so teams know what to fix, document, or strengthen."
        },
        {
            title: "Structured Delivery Model",
            description: "Auriseg uses a defined engagement flow to move quickly from review to remediation planning and audit preparation."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Audit Readiness for Modern Teams
                        </h2>
