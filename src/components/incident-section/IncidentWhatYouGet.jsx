    ...
    const cards = [
        {
            ...
            description: "Auriseg rapidly validates alerts, confirms scope, and identifies the severity of the incident. Your team gets clear direction immediately, not noisy speculation."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Containment & Eradication",
            description: "Once an incident is confirmed, Auriseg helps isolate affected systems, block attacker activity, and remove persistence mechanisms. The focus is on stopping spread and restoring control."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Recovery & Reporting",
            description: "Auriseg coordinates recovery actions, supports return-to-service decisions, and delivers a detailed post-incident report. You get timeline clarity, root-cause insights, and next-step recommendations"
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement includes structured containment, forensic investigation, and guided recovery — built to help teams respond quickly and confidently under pressure.
                        </p>
