        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/incident-response/Incident Response.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px', width: '100%' }}>
                        <div className="max-w-[900px]">
                            ...
                            >
                                Contain Fast And <br />
                                <span style={{ color: '#FF5536' }}>Recover Smarter.</span>
                            </h1>
                            ...
                            >
                                Auriseg delivers rapid incident response with expert containment, forensic clarity, and coordinated remediation — helping you reduce impact before damage spreads.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('incident-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('incident-process-timeline-mobile') || document.getElementById('incident-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
