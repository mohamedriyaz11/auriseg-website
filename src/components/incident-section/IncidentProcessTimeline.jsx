...
const stats = [
  { value: '24/7', label: 'IR Coverage' },
  { value: '4-Hours', label: 'Deployment Capability' },
  { value: '100%', label: 'Faster Containment Cycles' },
  { value: '99.98%', label: 'Clear, Actionable \nPost-Incident Reporting' },
];

const steps = [
  {
    title: '1. Intake Call',
    description: 'Confirm incident details, affected assets, business impact, and immediate priorities.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Scope Validation',
    description: 'Verify logs, telemetry, and indicators to determine the true extent of the event.platform.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Containment Actions',
    description: 'Isolate systems, disable malicious activity, and reduce attacker movement.',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Eradication&Recovery',
    description: 'Remove persistence, support cleanup, and guide restoration steps.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Post-Incident Review',
    description: 'Deliver findings, root cause, and corrective actions to strengthen future response',
    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Auriseg's incident response process is designed to move quickly from confirmation to containment, with a clear structure from the first call onward.
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="incident-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
