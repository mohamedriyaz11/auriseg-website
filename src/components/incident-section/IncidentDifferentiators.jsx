    ...
    const features = [
        {
            ...
            description: "Response teams mobilize quickly with a defined process that shortens time to containment."
        },
        {
            title: "Forensic-Ready Approach",
            description: "Evidence is preserved, timelines are documented, and actions are tracked for clarity and defensibility."
        },
        {
            title: "Clear Escalation Path",
            description: "You get direct access to experienced responders without delays, ticket loops, or uncertainty."
        },
        {
            title: "Recovery Focus",
            description: "Auriseg does not stop at containment; the process continues through remediation, reporting, and lessons learned"
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Pressure and Proven in Response.
                        </h2>
