...
const stats = [
  { number: '24/7', subNumber: '365', description: 'Incident Response Readiness' },
  { number: '<30-Min', description: 'Initial Triage SLA' },
  { number: '4-Hours', description: 'Rapid Deployment Window' },
  { number: '100%', description: 'Faster Containment. Lower Impact.' },
];
