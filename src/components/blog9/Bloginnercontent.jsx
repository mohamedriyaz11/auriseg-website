...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  "Your SCADA Isn’t Safe: 4 OT Threats That Can Silently Kill Your Operations",
  "Why OT Breaches Hurt More?",
  "4 Silent OT Threats That Impact Operations",
  "Why Traditional IT Security Isn’t Enough",
  "How Auriseg Protects Your SCADA and OT?",
  "Ready to Find the Silent Threats in Your OT?"
];
...
const SECTIONS = [
  {
    id: 's0',
    heading: "Your SCADA Isn’t Safe: 4 OT Threats That Can Silently Kill Your Operations",
    body: [
      <>
        SCADA and OT systems were designed for stability and uptime, not for modern cyber threats.
        These systems, when connected for
        <span style={{ color: '#FF5536' }}>
          {' '}remote monitoring, IIoT and analytics,
        </span>
        {' '}inherit all the risks of IT without the same level of protection.
        <br /><br />

        The dangerous part? Many critical OT threats don't announce themselves with obvious alerts.
        They slowly undermine safety, reliability, and availability until a "small anomaly" leads to an unplanned shutdown.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'Why OT Breaches Hurt More?',
    hasTable: true,
    body: [
      <>
        While IT focuses on data, OT focuses on
        <span style={{ color: '#FF5536' }}>
          {' '}production, equipment damage, safety, and environmental impact.
        </span>
        <br /><br />

        For OT, availability is the highest priority, followed by integrity, then confidentiality.
        This is in contrast to traditional IT, which has always prioritised risks differently.
        <br /><br />

        This is why attacks on SCADA, PLCs, and field devices can be more devastating.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: '4 Silent OT Threats That Impact Operations',
    body: [
      <>
        <span style={{ color: '#FF5536' }}>Threat 1: Unseen Pathways from IT to OT</span>
        <br /><br />

        IT and OT converge to improve efficiency, opening pathways between corporate networks and industrial control systems.
        A misconfigured VPN, shared Active Directory, or poorly segmented firewall rules can create a bridge to your SCADA environment.
        <br /><br />

        Attackers increasingly target these interfaces and interconnected systems because they are easier to compromise and less monitored.
        If an incident starts on a workstation or application server, it can quietly spread to HMIs, historians, and engineering workstations that directly influence processes.

        <br /><br />

        <span style={{ color: '#FF5536' }}>Threat 2: Legacy Systems with “Invisible” Vulnerabilities</span>
        <br /><br />

        SCADA and OT assets are often old and running outdated systems that were never designed with cybersecurity in mind.
        Patching can be restricted, leaving vulnerabilities exposed for years.
        <br /><br />

        Devices often lack built-in security and logging, making compromise undetected.
        Long-term degradation or disruption can result simply from maintaining covert access, adjusting parameters, or siphoning data.

        <br /><br />

        <span style={{ color: '#FF5536' }}>Threat 3: Compromised Remote Access and Third Parties</span>
        <br /><br />

        Remote access is now indispensable in modern OT because of remote operations, vendor maintenance, and field support.
        Poorly controlled remote access creates a high-value entry point.
        <br /><br />

        If a third-party engineer's laptop is compromised, attackers can "inherit" authorised access into your SCADA network.
        This access often appears legitimate, so malicious activity may blend in with normal maintenance and configuration changes unless OT-specific monitoring is in place.

        <br /><br />

        <span style={{ color: '#FF5536' }}>Threat 4: Subtle Manipulation of Process Data</span>
        <br /><br />

        OT attacks can be subtle, and the adversary aims to manipulate sensor values without triggering failsafes.
        This can lead to incorrect decisions due to perceived accuracy.
        <br /><br />

        Tampering with data, historian records, or alarms can weaken process safety over time.
        The perceived "failure" may appear like an equipment fault or process deviation,
        but the cause is a long-term compromise in the control environment.
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: "Why Traditional IT Security Isn’t Enough",
    body: [
      <>
        Standard IT controls don't work in OT environments because they're not designed to handle the operational constraints present.
        <br /><br />

        In SCADA systems, security measures need to preserve
        <span style={{ color: '#FF5536' }}>
          {' '}real-time performance, deterministic behaviour, and safety interlocks.
        </span>
        <br /><br />

        Simply "copying IT" often increases OT risk.
        <br /><br />

        OT needs security that can handle Modbus, DNP3, IEC standards,
        and vendor-specific traffic.
        This special visibility is needed to monitor OT risks.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'How Auriseg Protects Your SCADA and OT?',
    hasChecklist: true,
    body: [
      <>
        Auriseg's business-driven approach considers industrial realities,
        not just compliance checklists.
        Key elements include:
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>OT and SCADA security assessments:</span>
        {' '}Mapping critical assets, data flows, and trust boundaries, then identifying misconfigurations,
        weak segmentation, and exploitable attack paths between IT and OT.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>SCADA penetration testing:</span>
        {' '}Emulating real-world adversaries to test how far an attacker could go from internet-facing
        or corporate entry points into control networks and engineering workstations.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Managed OT and SOC services:</span>
        {' '}24/7 monitoring and incident response, integrating OT-aware detection with threat intelligence
        so subtle anomalies in industrial traffic don't get ignored.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Architecture review and hardening:</span>
        {' '}Designing or refining network zones, conduits, remote access controls,
        and identity management to reduce lateral movement and unneeded exposure of SCADA components.
        <br /><br />

        ● <span style={{ color: '#FF5536' }}>Security awareness and simulation:</span>
        {' '}Phishing simulations, training, and playbooks so engineers,
        operators, and third parties recognise and respond to OT-targeted attacks quickly.
        <br /><br />

        By combining continuous monitoring with targeted assessments and red-team style testing,
        Auriseg helps you move from reactive firefighting to proactive OT risk management.
      </>
    ],
  },
  ...
  {
    id: 's5',
    heading: 'Ready to Find the Silent Threats in Your OT?',
    body: [
      <>
        Connect with Auriseg today to schedule an OT & SCADA security assessment,
        or reach out to our team to explore how our
        <span style={{ color: '#FF5536' }}>
          {' '}OT, IoT and IIoT security services
        </span>
        {' '}can protect your operations before the next silent threat does.
      </>
    ],
  },
];
