                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Turn Compliance <br />Complexity into<br />
                                <span style={{ color: '#FF5536' }}>Competitive Advantage </span>
                            </h1>
                            ...
                            >
                                Auriseg delivers end-to-end regulatory compliance management that transforms fragmented obligations into a unified, audit-ready program. With continuous controls monitoring, expert-led assessments, and automated evidence collection, we eliminate your compliance blind spots without overwhelming your internal teams.
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('regulatory-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="text-center mb-4 w-full">
                            ...
                            >
                                Turn Compliance Complexity into
                            </h1>
                            <h1
                                style={{
                                    fontFamily: "'Cabinet Grotesk', sans-serif",
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('regulatory-process-timeline-mobile') || document.getElementById('regulatory-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
