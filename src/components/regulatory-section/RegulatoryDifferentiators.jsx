...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Multi-Framework Coverage in One Program",
            description: "A single engagement maps your controls across all applicable regulations simultaneously, eliminating duplicate assessments and redundant documentation."
        },
        {
            title: "Transparent, Predictable Pricing",
            description: "Per-framework, per-engagement pricing lets compliance officers forecast costs accurately and present clear ROI to leadership."
        },
        {
            title: "Direct Access to Regulatory Specialists",
            description: "Get immediate escalation to framework-specific experts — CISA-certified, HIPAA-trained, PCI QSAs — with no ticket queues and no generalist layers."
        },
        {
            title: "Dedicated Compliance Engineer",
            description: "A named specialist manages your entire engagement, from initial scoping through final audit close, ensuring continuity and accountability at every stage."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Compliance Leaders. Proven in Regulated Industries.
                        </h2>
