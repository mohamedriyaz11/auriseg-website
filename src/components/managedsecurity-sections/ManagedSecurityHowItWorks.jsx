  ...
  const steps = [
    {
      ...
      title: "",
      description: "Rapidly baseline your environment assets, exposures, and active threat vectors identified."
    },
    {
      label: "Onboard",
      icon: "/icons/how-it-works/2.png",
      title: "",
      description: "Deploy monitoring integrations within 48 hours, zero disruption to existing operations."
    },
    {
      label: "Detect",
      icon: "/icons/how-it-works/3.png",
      title: "",
      description: "Continuous multi-signal telemetry surfaces threats before they escalate into incidents."
    },
    {
      label: "Respond",
      icon: "/icons/how-it-works/4.png",
      title: "",
      description: "Contain, eradicate, and recover with documented playbooks and expert-led execution."
    }
  ];
