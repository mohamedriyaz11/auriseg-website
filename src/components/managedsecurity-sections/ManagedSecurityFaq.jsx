...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Q1: What is a Managed Security Service Provider (MSSP)?",
      answer: "An MSSP delivers outsourced 24/7 security monitoring, threat detection, and incident response, providing organizations enterprise-grade protection without building an in-house SOC."
    },
    {
      question: "Q2: How quickly can Auriseg onboard my organization?",
      answer: "Full monitoring coverage activates within 48 hours. Threat detection goes live before your first week ends, no prolonged deployment cycles."
    },
    {
      question: "Q3: How does Managed Security differ from MDR?",
      answer: "MSSPs provide broad security monitoring and management. MDR adds active threat hunting, human-led investigation, and hands-on containment reducing dwell time from months to minutes."
    },
    {
      question: "Q4: Will Auriseg's services integrate with our existing tools?",
      answer: "Auriseg operates platform-agnostic, integrating with your SIEM, EDR, firewall, and cloud environments without displacing your current investments."
    }
  ];
