  ...
  const services = [
    {
      ...
      description: 'Continuous, eyes-on monitoring of your entire environment, detecting threats before they escalate into incidents.',
      link: '/services/247-monitoring',
      linkText: 'Explore →',
    ...
    },
    {
      ...
      description: 'AI-driven threat hunting combined with human expertise — MTTR reduced by up to 90%.',
      link: '/services/mdr',
      linkText: 'Explore →',
    ...
    },
    {
      ...
      description: 'Enterprise-grade security leadership on demand aligned to your risk posture and business goals.',
      link: '/services/vciso',
      linkText: 'Explore →',
