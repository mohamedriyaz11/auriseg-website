...
const MSPStats = () => {
  ...
  const stats = [
    { number: '15+', description: 'Compliance Frameworks\nSupported ' },
    { number: '60%', description: 'Reduction in audit\npreparation time' },
    { number: '100%', description: 'Cross-industry applicability' },
    { number: '24/7/365', description: 'Risk posture visibility' },
  ];
