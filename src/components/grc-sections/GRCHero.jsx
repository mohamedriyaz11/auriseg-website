      ...
      <div className="hidden md:block w-full relative z-10 pt-32 pb-16 sm:pb-20 md:pb-24" style={{ maxWidth: '1440px', margin: '0 auto', paddingLeft: 'clamp(24px, 6.94vw, 100px)', paddingRight: 'clamp(24px, 6.94vw, 100px)', boxSizing: 'border-box' }}>
        <div className="flex flex-col items-start justify-start text-left">
          <div className="w-full max-w-[600px]">
            ...
            >
              Everything Compliance Demands. One<br className="hidden md:block" />
              <span style={{ color: '#FE5538' }}>Managed Program.</span>
            </h1>
            ...
            >
              Auriseg unifies governance, risk management, and compliance into a single, operationalized program, so your organization stays audit-ready, penalty-free, and resilient.
            </p>
        ...
        >
          ...
          <div className="w-full px-4 flex flex-col gap-6">
            ...
            <div className="w-full flex justify-start">
              ...
              >
                Everything Compliance Demands. One<br />
                <span style={{ color: '#FE5538' }}>Managed Program.</span>
              </h1>
            </div>
