  ...
  const problems = [
    {
      ...
      description: 'Disconnected governance tools create blind spots regulators and attackers both exploit.',
      icon: '/icons/msp/soc-cost-icon.png'
    },
    {
      title: 'Regulatory Overload',
      description: 'GDPR, HIPAA, ISO 27001, DORA, overlapping mandates drain resources without a unified framework.',
      icon: '/icons/msp/analyst-shortage-icon.png'
    },
    {
      title: 'Third-Party Exposure',
      description: 'Vendors and partners introduce unmonitored risk that sits outside your perimeter and inside your liability.',
      icon: '/icons/msp/coverage-icon.png'
    },
    {
      title: 'Audit Unpreparedness',
      description: 'Manual evidence gathering delays audits, exposes gaps, and erodes stakeholder confidence at critical moments.',
