  ...
  const features = [
    {
      ...
      description: "Operate across NIST, ISO 27001, SOC 2, COBIT, and DORA, without rebuilding your program for every mandate."
    },
    {
      title: "Compliance-Integrated",
      description: "Risk and compliance functions operate in unison, delivering consistent, measurable control assurance."
    },
    {
      title: "Advisor-Led",
      description: "Senior GRC practitioners lead every engagement, more than junior analysts with checklists and generic deliverables."
    },
    {
      title: "Continuously Monitored",
      description: "Auriseg delivers live risk visibility, 24/7/365, across your full environment."
    }
  ];
