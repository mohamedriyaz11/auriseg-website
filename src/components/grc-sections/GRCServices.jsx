  ...
  const services = [
    {
      ...
      description: 'Identify, quantify, and prioritize enterprise-wide cyber risks using NIST, ISO 27001, and COBIT-aligned frameworks.',
    ...
    },
    {
      ...
      description: 'Map obligations across GDPR, HIPAA, PCI DSS, and NIS2, then close gaps before regulators find them.',
      link: '/services/regulatory-compliance',
      linkText: 'Explore →',
      icon: '/icons/msp/threat-icon.png'
    },
    {
      title: 'Policy and Process Advisory',
      description: 'Build defensible, enforceable security policies aligned to your business model, risk appetite, and regulatory environment.',
      link: '#',
      linkText: 'Explore →',
    ...
    },
    {
      ...
      description: 'Continuously score and monitor vendor security postures, before a partners vulnerability becomes your breach.',
      link: '#',
      linkText: 'Explore →',
      icon: '/icons/msp/whitelabel-icon.png'
    },
    {
      title: 'Audit Readiness & Reporting',
      description: 'Reduce audit preparation time with continuous evidence collection, control validation, and board-ready reporting dashboards.',
      link: '/services/audit-readiness',
      linkText: 'Explore →',
      icon: '/icons/msp/codelivery-icon.png'
    },
    {
      title: 'AI Governance and Responsible Compliance',
      description: 'Establish accountability frameworks for AI systems, before regulators mandate it. Algorithm-aware. Audit-defensible.',
      link: '#',
      linkText: 'Explore →',
