...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  "Counter with Integrated Threat Hunting and SOC 2-Aligned AI Defences",
  "The Rise of Proactive Threat Hunting",
  "SOC 2 Alignment Essentials",
  "Integrated Counter: AI + Hunting + Compliance",
  "Real-World Analytics and ROI",
  "Why Act Now?",
...
const SECTIONS = [
  {
    id: 's0',
    heading: 'Counter with Integrated Threat Hunting and SOC 2-Aligned AI Defences',
    body: [
      <>
        Organisations can proactively counter threats with a unified platform that integrates
        <span style={{ color: '#FF5536' }}>
          {' '}threat hunting with SOC 2-compliant AI defences,
        </span>
        {' '}ensuring compliance and offering a competitive advantage in today's digital landscape.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'The Rise of Proactive Threat Hunting',
    hasTable: true,
    body: [
      <>
        Threat hunting is a proactive process that involves searching for hidden threats that evade automated tools.
        This is done using hypotheses, IOCs, and behavioural analysis.
        <br /><br />

        The cyber threat hunting services market, valued at
        <span style={{ color: '#FF5536' }}> USD 9.66 billion in 2025</span>,
        {' '}is projected to grow at a compound annual growth rate (CAGR) of 15.44%
        to USD 30.47 billion by 2033, driven by rising attack sophistication.
        <br /><br />

        AI augments this by surfacing anomalies, scoring risks, and clustering events,
        enabling faster hunts without replacing human expertise.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'SOC 2 Alignment Essentials',
    body: [
      <>
        SOC 2 emphasises security by requiring robust monitoring, incident response,
        and evidence collection.
        <br /><br />

        Controls include
        <span style={{ color: '#FF5536' }}>
          {' '}EDR/XDR deployment, intrusion detection, vulnerability management,
          and real-time logging,
        </span>
        {' '}enhanced by AI for validation.
        <br /><br />

        AI platforms automate evidence gathering for controls like MFA enforcement
        and firewall changes, supporting multi-framework compliance and reducing
        annual audit exceptions, affecting 98% of SOC 2 Type 2 reports.
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: 'Integrated Counter: AI + Hunting + Compliance',
    body: [
      <>
        The focus is on Trust Services Criteria.
        <span style={{ color: '#FF5536' }}>
          {' '}CC6 (Logical Access) and CC7 (System Operations)
        </span>
        {' '}are used for monitoring and response.
        <br /><br />

        Key controls: EDR/XDR deployment, vulnerability scans,
        and real-time logs are all supported by AI to ensure continuous compliance.
        <br /><br />

        This system automates the evidence for MFA and firewalls,
        reducing common audit exceptions in Type 2 reports by 98%.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'Real-World Analytics and ROI',
    body: [
      <>
        Organisations using AI-powered SOCs report
        <span style={{ color: '#FF5536' }}>
          {' '}240% ROI over three years,
        </span>
        {' '}with $4.3M NPV from 70% risk reduction and 50% faster MTTR.
        <br /><br />

        IBM data shows AI/automation saves $3.05M per breach;
        threat hunting prevents incidents in 72% of surveyed;
        these Case studies highlight 25% client growth post-SOC 2 via integrated EDR and controls.
      </>
    ],
  },
...

  {
    ...
    body: [
      <>
        ● Threats are evolving, and regulations are tightening.
        <br /><br />

        ● Integrate threat hunting and SOC 2-aligned AI defences.
        <br /><br />

        ● Transform your SOC from reactive to resilient.
        <br /><br />

        ● Early adopters gain efficiency, compliance, and competitiveness.
