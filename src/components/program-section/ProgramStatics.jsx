...
const stats = [
  { number: '3X', subNumber: '', description: 'Faster program maturity uplift vs. self-directed builds' },
  { number: '72-Hrs', description: 'gap assessment turnaround from kickoff' },
  { number: '95%', description: 'Clients achieve first-year roadmap milestones on schedule' },
  { number: '100%', description: 'Framework-aligned delivery — NIST, ISO 27001, CIS, SOC 2' },
];
