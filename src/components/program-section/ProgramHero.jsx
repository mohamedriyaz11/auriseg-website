        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/program-advisory/Program Advisory.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Turn Security Goals<br />Into A Program That <br />
                                <span style={{ color: '#FF5536' }}>Actually Moves</span>
                            </h1>
                            ...
                            >
                                Auriseg helps organizations build and strengthen security programs with strategic advisory, maturity assessments, roadmap planning, and execution guidance — so leadership gets a clearer direction and teams make measurable progress.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                >
                                    ...
                                    >
                                        Start Program Advisory →
                                    </span>
                                </Link>

                                <button
                                    onClick={() => {
                                        const el = document.getElementById('program-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="text-center mb-4 w-full">
                            ...
                            >
                                Turn Security Goals Into a Program That
                            </h1>
                            <h1
                                style={{
                                    fontFamily: "'Cabinet Grotesk', sans-serif",
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('program-process-timeline-mobile') || document.getElementById('program-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
