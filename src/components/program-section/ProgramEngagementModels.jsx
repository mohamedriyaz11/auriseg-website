    ...
    const models = [
        {
            ...
            description: "A focused engagement to review current maturity, identify program gaps, and highlight priority areas for improvement."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Strategic Advisory and Roadmap Design",
            description: "A broader engagement for organizations that need leadership guidance, capability planning, and a structured multi-phase program roadmap."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Ongoing Advisory Support",
            description: "Continuous support for teams that need recurring strategic input, roadmap refinement, and guidance through execution and program evolution."
        }
    ];
