...
const ThreatIntegrations = () => {
    const integrations = {
        ...
        cloud: ['SIEM data', 'policies', 'asset inventories', 'compliance evidence', 'risk registers', 'operating documents']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg works with your current environments, governance inputs, and security tooling — no rip-and-replace required.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            {/* Governance / Security Inputs  Row */}
                            <div className="flex">
                                <div
                                    className="flex-shrink-0"
                                    style={{
                ...
                <div className="w-full px-4">
                    <div className="max-w-[342px] mx-auto">
                        ...
                        >
                            ...
                            {/* Governance / Security Inputs  - Mobile */}
                            <div>
                                <div
                                    style={{
                                        background: '#FFFFFF',
