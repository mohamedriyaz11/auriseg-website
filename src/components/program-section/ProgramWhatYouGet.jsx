    ...
    const cards = [
        {
            ...
            description: "Auriseg evaluates your current security program across governance, controls, processes, resources, and operating maturity. This helps identify what is working, where gaps exist, and where improvement will have the most impact."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Strategic Alignment",
            description: "Every recommendation is mapped to business priorities, regulatory needs, and risk exposure. Auriseg helps connect security initiatives to practical outcomes so the program supports both resilience and growth."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Roadmap Advisory",
            description: "You receive a structured improvement roadmap with prioritized next steps, capability recommendations, and execution guidance. The goal is to move from scattered initiatives to a more focused and sustainable security program."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Build Security That Stays Resilient
                        </h2>
                        ...
                        >
                            Every engagement includes targeted OT/IoT and automotive security testing, deployment validation, and practical remediation guidance built to help engineering, security, and manufacturing teams move fast without putting plants, fleets, or passengers at risk.
                        </p>
