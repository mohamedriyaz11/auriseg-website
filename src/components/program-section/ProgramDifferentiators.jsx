...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Business-Aligned Security Planning",
            description: "Auriseg helps ensure security priorities support operational goals, growth plans, and risk realities."
        },
        {
            title: "Practical Program Maturity Guidance",
            description: "Recommendations are based on what organizations can realistically improve, not abstract maturity models alone."
        },
        {
            title: "Roadmaps That Drive Action",
            description: "Findings are translated into sequenced actions so teams know what to do now, next, and later."
        },
        {
            title: "Advisory That Connects Leadership and Delivery",
            description: "Auriseg helps bridge executive expectations with the operational work needed to make the program move.    "
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Strategy. Grounded in Execution.
                        </h2>
