...
const IndustriesStats = () => {
  const stats = [
    {
      value: "5",
      description: "Consecutive years for highest regulated sector globally",
    },
    {
      value: "74%",
      description: "At least one financial institution suffered a ransomware attack that disrupted core banking operations.",
    },
    {
      value: "18 min",
      description: "Average time attackers move laterally inside financial networks before detection and window measured in millions",
    }
  ];
