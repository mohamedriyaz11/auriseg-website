...
const IndustriesProblem = () => {
  ...
  const problems = [
    {
      title: "Ransomware Targets Core Banking Infrastructure ",
      description: "Attackers steal data and disrupt systems, holding customer funds. Downtime costs financial institutions $1.45M per day.",
      image: "/images/industries_navbar/healthcare/problem-ransomware.jpg",
    },
    {
      title: "Third-Party Integrations Multiply Attack Surface",
      description: "Fintech APIs, cloud banking platforms and payment processors connect directly to core systems running on legacy architecture, leaving them vulnerable to breaches.",
      image: "/images/industries_navbar/healthcare/problem-iomt.jpg",
    },
    {
      title: "Regulatory Risk Is Accelerating",
      description: "PCI DSS 4.0, DORA, SEC rules and state-level mandates require controls, monitoring and 72-hour breach notification; penalties are up to $2.5M per violation.",
      image: "/images/industries_navbar/healthcare/problem-regulatory.jpg",
    },
    {
      title: "Insider Threats Evade Detection",
      description: "Privileged users cause 41% of financial breaches. Behavioral analytics prevent fraud and theft.",
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Why Financial Services Is the #1 Target for Cyberattacks
            </h2>
