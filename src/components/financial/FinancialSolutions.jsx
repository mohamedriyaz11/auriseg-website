  ...
  const solutions = [
    {
      ...
      title: "Financial SOC-as-a-Service",
      description: "24/7 threat and incident detection and response tailored to financial contexts. Analysts triage trading and banking alerts, distinguishing anomaly from fraud."
    },
    {
      icon: "/images/industries_navbar/healthcare/icon-soc.png",
      title: "PCI DSS & DORA Compliance Augmentation",
      description: "Gap assessments, policy remediation and technical controls mapped to PCI DSS 4.0, DORA and SEC cybersecurity disclosure requirements.Audit-ready documentation included."
    },
    {
      icon: "/images/industries_navbar/healthcare/icon-hipaa.png",
      title: "Ransomware Resilience & Recovery",
      description: "Backups, air-gapped recovery environments and tested playbooks for financial institutions. Restore operations fast."
    },
    {
      icon: "/images/industries_navbar/healthcare/icon-ztna.png",
      title: "API & Third-Party Risk Security",
      description: "Discover, segment and monitor fintech integrations and third-party APIs. Reduce risk without disrupting payments or services."
    },
    {
      icon: "/images/industries_navbar/healthcare/icon-ransomware.png",
      title: "Zero Trust Network Access (ZTNA)",
      description: "Replace implicit trust with identity-verified, least-privilege access across on-premises core banking, cloud platforms, and remote financial staff. Deploy in weeks, not quarters."
    },
    {
      icon: "/images/industries_navbar/healthcare/icon-workforce.png",
      title: "Workforce Security Augmentation",
      description: "Auriseg analysts can be embedded in your IT and security teams. This fills skills gaps and allows for scaling up in times of M&A activity, audits or breach responses."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Auriseg’s Financial Services Security Stack
            </h2>
