...
const IndustriesCaseStudies = () => {
  ...
  const caseStudies = [
    {
      id: 1,
      title: "Financial Services Success Story",
      image: "/images/industries_navbar/healthcare/case-study-1.jpg",
      description: "",
      challenge: [
        "No asset inventory for fintech integrations and cloud workloads across 12 branch locations",
        "Active third-party vendor agreement violations with 4 payment processors",
        "Staff credentials exposed in a prior dark web data leak and undetected for 11 months",
        "No incident response plan or regulatory breach notification protocol in place"

      ],
      solution: [
        "Deployed Auriseg network discovery and segmentation across all 12 branches in 3 weeks",
        "Executed emergency PCI DSS compliance reviews and vendor risk remediations",
        "Launched 24/7 SOC monitoring with identity threat detection and fraud analytics enabled on Day 1",
        "Delivered PCI-aligned IR playbook and conducted full-staff tabletop exercise",

      ],
      impact: [
        { value: "100%", label: "third-party integrations discovered, classified, and risk-rated before audit date" },
        { value: "4", label: "critical vendor violations remediated audit passed with zero findings" },
        { value: "3-Hrs", label: "MTTR reduced from 19 days to 3 hours post-SOC deployment" },
        { value: "$3.2M", label: "potential PCI DSS fines avoided based on violation categories identified" }
      ],
