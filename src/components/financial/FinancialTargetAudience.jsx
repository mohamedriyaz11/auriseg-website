  ...
  const audiences = [
    {
      ...
      description: "Auriseg scales security operations without adding headcount, even in multi-branch environments with complex integrations and IT scrutiny."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-physician-groups.jpg",
      title: "Wealth Management & Investment Firms",
      description: "IT teams with no dedicated security staff are managing trading systems and investor portals. Auriseg provides full security services."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-ambulatory.jpg",
      title: "Fintech & Payments Companies",
      description: "All Financial data must meet PCI, DSS, SOC 2, and customer security requirements. Auriseg ensures compliance and security from product architecture through to deployment."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-digital-health.jpg",
      title: "Insurance & Specialty Finance Providers",
      description: "Policyholder records and actuarial data are sensitive and at risk. Auriseg applies data protection controls tailored to your client population and obligations."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Trusted Cybersecurity for a High-Risk Financial World.
            </h2>
