...
const MSPStats = () => {
  ...
  const stats = [
    { number: '200+', description: 'Engagements Completed' },
    { number: '98%', description: 'Client Retention Ratebility' },
    { number: '15+', description: 'Industries Served' },
    { number: '48-hrs', description: 'Avg. Engagement Kickoff' },
  ];
