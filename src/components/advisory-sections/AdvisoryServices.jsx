  ...
  const services = [
    {
      ...
      description: 'Design and validate security architectures that protect critical assets without disrupting business operations.',
      link: '/services/security-architecture',
      linkText: 'Explore →',
      icon: '/icons/msp/soc-icon.png'
    },
    {
      title: 'Program Advisory',
      description: 'Build and mature security programs aligned with business goals, risk appetite, and regulatory requirements.',
      link: '/services/program-advisory',
      linkText: 'Explore →',
      icon: '/icons/msp/threat-icon.png'
    },
    {
      title: 'vCISO Services',
      description: 'Embedded security leadership on demand board-ready strategy, team mentoring, and full accountability.',
      link: '/services/vciso',
      linkText: 'Explore →',
      icon: '/icons/msp/incident-icon.png'
    },
    {
      title: 'Security Tool Selection & Implementation',
      description: 'Evaluate, select, and deploy the right security tools matched precisely to your environment and budget.',
      link: '/services/tool-selection',
      linkText: 'Explore →',
      icon: '/icons/msp/whitelabel-icon.png'
    },
    {
      title: 'Maturity Assessments',
      description: 'Benchmark your security posture against industry frameworks, uncover gaps, and prioritize measurable improvements.',
      link: '/services/maturity-assessments',
      linkText: 'Explore →',
