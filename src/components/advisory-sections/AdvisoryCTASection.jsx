  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full h-full" style={{ maxWidth: '1440px', margin: '0 auto', paddingLeft: 'clamp(24px, 6.94vw, 100px)', paddingRight: 'clamp(24px, 6.94vw, 100px)', boxSizing: 'border-box' }}>
          <div className="w-full h-full flex items-center justify-between">
            ...
            >
              Ready to Know Where You Stand?<br />
              Stop guessing. Start knowing.
              <br />Let's secure your organization today.
