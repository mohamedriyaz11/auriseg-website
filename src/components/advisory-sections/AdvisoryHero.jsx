  ...
  return (
    <section className="relative w-full bg-dark min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full z-0 hidden md:block">
        <img
          src="/images/advisory-and-enablement/Advisory and Enablement.jpg"
          alt="Background"
      ...
      <div className="hidden md:block w-full relative z-10 pt-32 pb-16 sm:pb-20 md:pb-24" style={{ maxWidth: '1440px', margin: '0 auto', paddingLeft: 'clamp(24px, 6.94vw, 100px)', paddingRight: 'clamp(24px, 6.94vw, 100px)', boxSizing: 'border-box' }}>
        <div className="flex flex-col items-start justify-start text-left">
          <div className="w-full max-w-[600px]">
            {/* Advisory and Enablement - Badge with Icon */}
            ...
            >
              Security Strategy That<br className="hidden md:block" />
              Moves Your  <br className="hidden md:block" />
              <span style={{ color: '#FE5538' }}>Business Forward</span>
            </h1>
            ...
            >
              Auriseg partners with security leaders to build the programs, architectures, and capabilities that turn security into a competitive advantage.
            </p>
        ...
        >
          ...
          <div className="w-full">
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = '/images/advisory-and-enablement/Advisory and Enablement.jpg';
              }}
            />
          </div>

          <div className="w-full px-4 flex flex-col gap-6">
            {/* 2. Advisory and Enablement - Badge - Mobile */}
