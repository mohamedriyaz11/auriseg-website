  ...
  const steps = [
    {
      ...
      title: "",
      description: "We assess your current environment, risks, and priorities through structured discovery workshops and stakeholder interviews."
    },
    {
      label: "Align",
      icon: "/icons/how-it-works/2.png",
      title: "",
      description: "We map findings to business objectives, defining a security roadmap leadership can support and act on immediately."
    },
    {
      label: "Execute",
      icon: "/icons/how-it-works/3.png",
      title: "",
      description: "Our advisors work alongside your team to implement programs, controls, and tools that close gaps efficiently."
    },
    {
      label: "Sustain",
      icon: "/icons/how-it-works/4.png",
      title: "",
      description: "We build internal capability and governance so your team owns and advances the security program independently."
    }
  ];
