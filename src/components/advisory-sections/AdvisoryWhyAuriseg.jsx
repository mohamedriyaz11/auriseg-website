  ...
  const features = [
    {
      ...
      description: "Every engagement is led by active practitioners with hands-on experience in complex security environments across industries."
    },
    {
      title: "Rapid Deployment",
      description: "Our advisors integrate quickly without lengthy ramp-up, delivering value in weeks, not the quarters agencies typically need."
    },
    {
      title: "Measurable Results",
      description: "We measure success by your improved security posture and risk reduction, not by engagement hours or deliverable volume."
    },
    {
      title: "Vendor Neutral",
      description: "Auriseg holds no vendor affiliations, our tool recommendations are driven entirely by your specific needs and budget."
    }
  ];
