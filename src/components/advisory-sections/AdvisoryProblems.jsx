  ...
  const problems = [
    {
      ...
      description: 'No defined path from current posture to measurable, business-aligned security maturity.',
      icon: '/icons/msp/soc-cost-icon.png'
    },
    {
      title: 'Leadership Gaps',
      description: 'Boards demand security leadership but full-time CISO talent remains scarce and expensive.',
      icon: '/icons/msp/analyst-shortage-icon.png'
    },
    {
      title: 'Tool Sprawl',
      description: 'Redundant, poorly integrated tools drain budgets without delivering cohesive protection.',
    ...
    <section className="w-full bg-dark py-16 md:py-20">
      ...
      >
        ...
        <div className="mb-12 md:mb-16">
          ...
          >
            Security Teams Face Real, <span style={{ color: '#FE5538' }}>Costly Gaps </span>
          </h2>
        </div>
      ...
      <div className="md:hidden" style={{ padding: '0 20px' }}>
        ...
        <h2 style={{
          ...
          Security Teams Face Real, Costly Gaps
        </h2>
