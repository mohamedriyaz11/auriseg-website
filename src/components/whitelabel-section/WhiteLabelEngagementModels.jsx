    ...
    const models = [
        {
            ...
            description: "Your team stays in control while Auriseg acts as an embedded extension, sharing alerts, workloads, and escalations in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Fully Managed SOC",
            description: "Auriseg owns detection, triage, response, and reporting so your team can focus on growth and strategy."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "SOC Augmentation",
            description: "Fill coverage gaps with Auriseg expertise for after-hours, overflow, or specialized threat areas on demand"
        }
    ];
