        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/white-label-security/White-Label Security Services.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px', width: '100%' }}>
                        <div className="max-w-[900px]">
                            ...
                            >
                                Your SOC Presence Driven by <br />
                                <span style={{ color: '#FF5536' }}>Continuous Protection</span>
                            </h1>
                            ...
                            >
                                Auriseg gives MSPs a fully white-label SOC engine with elite analysts, AI-driven detection, and 24/7/365 response — so you can scale security without building a SOC from scratch.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                >
                                    ...
                                    >
                                        Launch Your White-Label SOC →
                                    </span>
                                </Link>

                                <button
                                    onClick={() => {
                                        const el = document.getElementById('whitelabel-process-timeline');
                                        if (el) {
                                            const offset = 100;
            ...
            <section className="md:hidden" style={{
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        {/* Incident Response  - Badge (Mobile) */}
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('whitelabel-process-timeline-mobile') || document.getElementById('whitelabel-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
