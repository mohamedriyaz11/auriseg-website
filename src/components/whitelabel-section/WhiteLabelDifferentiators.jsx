    ...
    const features = [
        {
            ...
            description: "Client portals, reports, and dashboards are fully branded to your MSP."
        },
        {
        ...
        },
        {
            ...
            description: "Direct access to Tier 2 and Tier 3 analysts means faster decisions and fewer ticket delays."
        },
        {
            title: "Dedicated Onboarding",
            description: "A named onboarding engineer helps get you operational in 72 hours or less."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            White-Label SOC Built for MSP Margins.
                        </h2>
