    ...
    const cards = [
        {
            ...
            description: "Auriseg monitors your clients’ environments around the clock. Every alert is triaged, correlated, and escalated with no unnecessary noise reaching your team"
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Threat Investigation",
            description: "Every high-fidelity alert triggers a structured investigation. Auriseg analysts trace the attack chain, validate threats, and deliver clear findings instead of raw alert dumps."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Incident Response",
            description: "When an incident is confirmed, Auriseg leads containment, coordinates remediation, and delivers a full post-incident report to reduce dwell time and limit damage."
        }
    ];
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            White-Label SOC Delivery, Day In and Day Out
                        </h2>
                        ...
                        >
                            Every engagement includes continuous monitoring, analyst-led investigations, and fast, platform-native response — packaged for MSPs that need enterprise-grade security without the overhead
                        </p>
