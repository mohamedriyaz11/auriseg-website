...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Security-First Maturity Perspective",
            description: "Auriseg provides a grounded view of current maturity based on evidence, process review, and operating reality — not just theoretical scoring."
        },
        {
            title: "Roadmap-Focused Guidance",
            description: "Findings are translated into improvement priorities that teams can actually act on, tied to roadmap and investment decisions."
        },
        {
            title: "Business and Risk Context",
            description: "Maturity recommendations are aligned to business needs and risk appetite, not abstract models alone."
        },
        {
            title: "Progress You Can Measure",
            description: "Assessments help leadership track maturity over time and connect security improvements to strategic direction."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Clarity for Modern Security Programs
                        </h2>
