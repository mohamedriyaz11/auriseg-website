    ...
    const models = [
        {
            ...
            description: "A focused review to establish your current state, identify major gaps, and clarify where your program stands today."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Targeted Capability Assessment",
            description: "A deeper assessment for specific domains such as governance, detection, response, compliance, architecture, or risk management."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Recurring Maturity Reviews",
            description: "Ongoing assessments that help organizations measure progress, validate improvements, and refine the roadmap over time."
        }
    ];
        ...
        <>
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    ...
                    {/* Built for How You Mature - Heading */}
                    <h2
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for How You Mature - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
