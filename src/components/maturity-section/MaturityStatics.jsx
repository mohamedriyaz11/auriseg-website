...
const stats = [
  { number: '12+', subNumber: '', description: 'Security domains assessed across frameworks' },
  { number: '72-Hrs', description: 'Report delivery from assessment kickoff' },
  { number: '95%', description: 'Clients act on roadmap within 30 days' },
  { number: '3X', description: 'Average maturity improvement within 12 months' },
];
