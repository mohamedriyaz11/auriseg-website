    ...
    const cards = [
        {
            ...
            description: "Auriseg evaluates your security program across governance, controls, operations, visibility, risk management, and supporting processes. This creates a realistic baseline of your current maturity."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Gap and Capability Analysis",
            description: "Each assessment identifies weaknesses, missing capabilities, process inefficiencies, and areas where existing efforts may not align with risk or business needs."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Improvement Roadmap",
            description: "You receive clear recommendations and a prioritized maturity roadmap so your team can focus resources on the changes that deliver the greatest impact over time."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter Insight. Stronger Maturity.
                        </h2>
                        ...
                        >
                            Every engagement includes maturity review, capability analysis, and prioritized recommendations — designed to help organizations understand where they are today and what will create the most meaningful security improvement next.
                        </p>
