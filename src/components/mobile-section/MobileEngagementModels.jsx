    ...
    const models = [
        {
            ...
            description: "Your team stays in control. Auriseg runs automated scans as an embedded extension  sharing vulns, proofs, and fixes in real time."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Full Security Assurance",
            description: "Offload it entirely. Auriseg owns scanning, pentesting, reporting, and retests  freeing your devs for features."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Pentest Augmentation",
            description: "Staff the gaps. Inject Auriseg mobile experts into your QA covering peak releases, complex apps, or OWASP Top 10 on demand."
        }
    ];
        ...
        <>
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    ...
                    {/* Built for How You Develop - Heading */}
                    <h2
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for How You Develop - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
