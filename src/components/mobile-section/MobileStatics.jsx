...
const stats = [
  { number: '24/7', subNumber: '', description: 'App Threat Scans' },
  { number: '<24-Hrs', description: 'Vulnerability Reports' },
  { number: '95%', description: 'Exploit Risk Reduction' },
  { number: '100%', description: 'OWASP Coverage. Zero Leaks.' },
];
