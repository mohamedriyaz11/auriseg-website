...
const ThreatIntegrations = () => {
    const integrations = {
        siem: ['MGitHub Actions', 'Jenkins, CircleCI', 'GitLab CI'],
        edr: ['Apple App Store Connect', 'Google Play Console', 'TestFlight'],
        firewall: ['Appium', 'FXCUITest', 'Espresso', 'Detox'],
        cloud: ['AWS Device Farm', 'Firebase Test Lab', 'BrowserStack', 'Sauce Labs']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg integrates with your dev toolstack — no rip-and-replace required.
                            </p>
                        </div>
