    ...
    const features = [
        {
            ...
            description: "Full white-label reports and dashboards, branded to your company"
        },
        {
            title: "Transparent Pricing",
            description: "Per-app, per-scan pricing with no hidden fees. Forecast costs precisely."
        },
        {
            title: "Expert Escalation Path",
            description: "Direct access to senior pentesters escalates in minutes, not days."
        },
        {
            title: "Dedicated Onboarding",
            description: "A named engineer owns your first scan. App testing live in 48 hours or less"
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Apps. Proven in Production.
                        </h2>
