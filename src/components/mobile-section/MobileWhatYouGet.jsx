    ...
    const cards = [
        {
            ...
            description: "Auriseg scans your live iOS/Android apps for runtime exploits. Every vulnerability is triaged, validated, and reported — with zero false positives hitting your devs."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Static Code Analysis",
            description: "Every code push triggers deep analysis. Auriseg experts trace insecure APIs, data leaks, and crypto flaws, delivering fix-ready reports — not vague scan dumps."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Risk Assurance",
            description: "When flaws are confirmed, Auriseg simulates real attacks, prioritizes remediations, and verifies fixes slashing exploit windows before launch."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement includes automated dynamic scans, manual code reviews, and platform-native fixes — purpose-built for mobile app security at scale.
                        </p>
