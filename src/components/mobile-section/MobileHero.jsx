        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/mobile-app-security/Mobile App Security Testing.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Confidence Starts <br />With Stronger<br />
                                <span style={{ color: '#FF5536' }}>Application Security </span>
                            </h1>
                            ...
                            >
                                Auriseg uncovers hidden mobile app vulnerabilities with AI-powered scans, expert penetration testing, and comprehensive assurance before attackers cash in and zero exploits.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('mobile-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="text-center mb-4 w-full">
                            ...
                            >
                                Confidence Starts with Stronger
                            </h1>
                            <h1
                                style={{
                                    fontFamily: "'Cabinet Grotesk', sans-serif",
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('mobile-process-timeline-mobile') || document.getElementById('mobile-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
