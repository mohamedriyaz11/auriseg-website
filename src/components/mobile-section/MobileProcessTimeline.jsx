...
const stats = [
  { value: '10K+', label: 'Apps Tested' },
  { value: '92%', label: 'Risk Reduction\nAvg. Client' },
  { value: '200+', label: 'Dev Teams Secured' },
...
const steps = [
  {
    ...
    description: 'Define app scope, platforms, threat model, and report format.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Scan Setup',
    description: 'Connect repo, CI/CD, and app binaries to Auriseg platform.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Baseline Testing',
    description: 'Run initial SAST/DAST scans, tune for your apps noise.',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Pentest Alignment',
    description: 'Co-create fix workflows mapped to your release cycles.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Go-Secure',
    description: 'Continuous testing activates. Reports start flowing.',
    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Auriseg's streamlined process gets your app tested fast from scoping to verified fixes in under a week.
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="mobile-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
