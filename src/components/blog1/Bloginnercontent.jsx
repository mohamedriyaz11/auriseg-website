...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  'Strengthening Security Starts with the Basics',
  'A Practical 10-Minute Security Checklist',
  'Why Security Hygiene Matters to Your Business',
  'How Auriseg Helps Build Continuous Security Confidence',
  'Turn Simple Security Checks into Long-Term Resilience',
];
...
const SECTIONS = [
  {
    id: 's0',
    heading: 'Strengthening Security Starts with the Basics',
    body: [
      <>
        For most organisations, the gap between “good” and “good enough” security isn’t due to missing exotic tools; it’s about failing to execute simple, high-impact hygiene consistently.
        <br />
        90%+ of breaches start with <span style={{ color: '#FF5536' }}>misconfigurations, unprotected identities, unpatched systems, or unchecked access</span>, but worrying about advanced threats while overlooking these basics is a strategic blind spot.
        <br />
        The 10-minute checklist below is designed to immediately verify that key controls are working correctly and uncover the risks that require your full attention.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'A Practical 10-Minute Security Checklist',
    hasTable: true,
    body: [
      <>
        Start with <span style={{ color: '#FF5536' }}>privileged access management</span>. Confirm that only authorised users have administrative rights and unnecessary accounts are removed or flagged for review.
        <br />
        Verify multifactor authentication across critical systems such as email, cloud platforms, and admin portals. Passwords alone are no longer enough for protecting sensitive data.
        <br />
        Review patch updates, validate backup protection, scan for phishing attempts, and check endpoint hygiene to prevent common security risks.
        <br />
        Finally, confirm incident response contacts and escalation paths are updated so teams know exactly how to act when issues occur.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'Why Security Hygiene Matters to Your Business',
    body: [
      <>
        Security maturity is measured by what an organisation can <span style={{ color: '#FF5536' }}>prevent, detect, and recover from.</span>
        <br />
        A short security checklist may seem simple, but it helps reduce avoidable incidents, increases visibility into weak spots, and improves readiness.
        <br />
        For executives and boards, this provides confidence that controls are working, risks are tracked, and cybersecurity supports business continuity.
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: 'How Auriseg Helps Build Continuous Security Confidence',
    hasChecklist: true,
    body: [
      <>
        Auriseg transforms security and compliance activities into measurable, repeatable actions instead of waiting for audits or breaches to expose weaknesses.
        <br />
        Auriseg helps organisations <span style={{ color: '#FF5536' }}>automate MFA, patch management, backup coverage, and access reviews</span> without manual processes.
        <br />
        It converts security checklists into continuous assurance through dashboards, compliance reports, and executive-ready insights.
        <br />
        With Auriseg, security becomes structured, visible, and actively managed across the organisation.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'Turn Simple Security Checks into Long-Term Resilience',
    body: [
      <>
        Ten minutes will not solve every cybersecurity challenge, but it can prevent many of the most common ones.
        <br />
        When performed consistently, a simple checklist becomes part of a stronger security culture.
        <br />
        <span style={{ color: '#FF5536' }}>Make security checks more structured and actionable with Auriseg.</span> Build better visibility, stronger governance, and a more resilient organisation.
      </>
    ],
  },
];
