...
const stats = [
  { number: '300+', subNumber: '', description: 'Risk Assessments Delivered Across Industries' },
  { number: '95%', description: 'Critical Risk Findings Remediated ' },
  { number: '12-Week', description: 'Average to Full Audit-Ready Risk Register' },
  { number: '40+', description: 'Regulatory Frameworks Assessed and Mapped ' },
];
