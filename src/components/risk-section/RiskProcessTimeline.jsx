...
const stats = [
  { value: '1000+', label: 'Critical Exposures Identified' },
  { value: '95%', label: 'Better Prioritization of\nRemediation' },
  { value: '150+', label: 'Improved Security\nDecision-Making' },
  { value: '99.9%', label: 'Stronger Visibility Across\nRisk Areas' },
];

const steps = [
  {
    title: '1. Scoping Call',
    description: 'Define assessment boundaries, business priorities, critical assets, and stakeholder expectations.',
    icon: '/icons/timeline/scoping-call.png',
  },
  {
    title: '2. Information Gathering',
    description: 'Review environments, controls, architecture, documentation, and available security data.',
    icon: '/icons/timeline/integration-setup.png',
  },
  {
    title: '3. Risk Analysis',
    description: 'Identify exposures, evaluate likelihood and impact, and group risks by severity and business relevance.panorays',
    icon: '/icons/timeline/baseline-tuning.png',
  },
  {
    title: '4. Recommendation Mapping',
    description: 'Develop remediation guidance, priority ranking, and improvement actions aligned to your environment.',
    icon: '/icons/timeline/playbook-alignment.png',
  },
  {
    title: '5. Findings Delivery',
    description: 'Present the assessment report, walk through key risks, and align next steps for remediation.',
    ...
    <>
      ...
      <div className="hidden md:block" style={{ width: '100%' }}>
        ...
        >
          ...
          >
            Auriseg’s assessment workflow moves from scope definition to prioritized findings quickly, giving your team clear insight without slowing delivery.scnsoft
          </p>
      ...
      <div className="md:hidden" style={{ width: '100%' }}>
        ...
        <section
          id="risk-process-timeline-mobile"
          style={{
            width: '100%',
            background: '#FFFFFF',
            paddingTop: '40px',
