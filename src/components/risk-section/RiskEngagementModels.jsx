    ...
    const models = [
        {
            ...
            title: "Point-in-Time Risk Assessment",
            description: "A focused engagement to identify immediate risks, review critical controls, and deliver prioritized recommendations."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Strategic Risk Review",
            description: "A broader assessment aligned to business operations, compliance objectives, and long-term security planning."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Ongoing Risk Advisory",
            description: "Continuous support for organizations that need recurring assessments, remediation validation, and evolving risk insight over time."
        }
    ];
