...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Business-Aligned Risk Prioritization",
            description: "Auriseg maps technical findings to business impact so teams can focus on what truly matters, not just what appears in a list."
        },
        {
            title: "Actionable Reporting",
            description: "Findings are presented with practical remediation guidance, not vague observations or generic risk summaries."
        },
        {
            title: "Broad Environment Coverage",
            description: "Assessments span infrastructure, cloud, access, applications, and operational controls to provide a fuller view of risk."
        },
        {
            title: "Fast, Structured Engagements",
            description: "A defined process moves quickly from discovery to reporting and remediation planning, avoiding drawn-out cycles."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Risk Clarity for Modern Enterprises
                        </h2>
