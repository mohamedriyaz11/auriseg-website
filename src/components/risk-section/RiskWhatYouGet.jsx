    ...
    const cards = [
        {
            ...
            description: "Auriseg identifies security weaknesses across your environment, including infrastructure, applications, cloud assets, access controls, and operational processes, surfacing the risks that could materially affect your business."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Impact Analysis",
            description: "Every identified issue is evaluated for likelihood, business impact, and exploitation potential, helping your team distinguish urgent risks from those that need longer-term planning."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Remediation Roadmap",
            description: "You receive practical recommendations with prioritized next steps so your team can reduce exposure in a structured and measurable way, keeping the focus on action, not just reporting."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter Risk Insight. Stronger Resilience.
                        </h2>
                        ...
                        >
                            Every engagement includes structured risk analysis, control review, and practical recommendations — designed to help organizations understand what is exposed, what matters most, and what to fix first.
                        </p>
