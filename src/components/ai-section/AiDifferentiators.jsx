...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Security-First AI Testing",
            description: "We look for real attack paths, not just compliance checklists."
        },
        {
            title: "Deployment-Focused Guidance",
            description: "Findings are tied to release decisions, engineering fixes, and go-live readiness."
        },
        {
            title: "Actionable Remediation",
            description: "Every issue comes with clear priority, impact, and practical next steps."
        },
        {
            title: "Built for Modern AI Stacks",
            description: "Works across LLM apps, agentic workflows, APIs, cloud deployments, and enterprise tooling."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Continuous Defense for Modern Enterprises
                        </h2>
