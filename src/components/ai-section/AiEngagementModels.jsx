    ...
    const models = [
        {
            ...
            description: "A focused engagement to uncover vulnerabilities in your AI application, prompts, workflows, APIs, and deployment controls."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Deployment Readiness Review",
            description: "A pre-launch validation layer for AI systems going into production, covering guardrails, logging, access, and incident response readiness."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Continuous AI Assurance",
            description: "Ongoing testing and validation for teams shipping AI frequently, with recurring assessments, change-based review, and release support."
        }
    ];
