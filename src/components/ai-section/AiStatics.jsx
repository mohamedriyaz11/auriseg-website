...
const stats = [
  { number: '300+', subNumber: '', description: 'AI Models & Pipelines Assessed' },
  { number: '95%', description: 'Critical AI Vulnerabilities Identified Pre-Deployment' },
  { number: '72-Hrs', description: 'Turnaround on AI Penetration Test Reports' },
  { number: '100%', description: 'Coverage Across Model, API, and Data Attack Surfaces ' },
];
