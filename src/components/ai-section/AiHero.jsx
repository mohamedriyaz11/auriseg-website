        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/ai-security/AI Security, Testing, Deployment.jpg"
                        ...
                        <div className="max-w-[900px]">
                            ...
                            <div className="mb-8">
                                ...
                                >
                                    ...
                                    >
                                        AI Security, Testing, Deployment
                                    </span>
                                </div>
                            </div>
                            ...
                            >
                                Security Solutions Built for <br />
                            ...
                            >
                                Auriseg helps you validate, harden, and safely deploy AI systems with security-first testing, adversarial assessment, and deployment assurance — so your models launch with confidence, not blind spots.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('ai-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('ai-process-timeline-mobile') || document.getElementById('ai-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
