    ...
    const cards = [
        {
            ...
            description: "Auriseg evaluates your AI systems for prompt injection, data leakage, model manipulation, unsafe outputs, and abuse paths. We identify where your AI can be influenced, exploited, or misused before attackers do."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Deployment Assurance",
            description: "We validate your AI deployment pipeline, access controls, logging, guardrails, and runtime protections. From staging to production, Auriseg helps ensure every release is secure, controlled, and auditable."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Red Team Validation",
            description: "Our security-led testing simulates real-world adversarial behavior against your AI applications and workflows. You get evidence-backed findings, prioritized risk insights, and actionable fixes not vague warnings."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Smarter Security Stronger Resilience
                        </h2>
                        ...
                        >
                            Every engagement includes targeted AI security testing, deployment validation, and practical remediation guidance — built to help teams move fast without shipping unsafe models or exposed workflows.
                        </p>
