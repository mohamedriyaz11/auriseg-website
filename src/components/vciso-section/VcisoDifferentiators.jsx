    ...
    const features = [
        {
            ...
            description: "Auriseg helps ensure security priorities support operational goals, growth plans, and organizational risk tolerance."
        },
        {
            title: "Practical Executive Guidance",
            description: "Recommendations are clear, usable, and tailored to decision-makers who need direction without unnecessary complexity."
        },
        {
            title: "Governance and Reporting Discipline",
            description: "Leadership gets stronger visibility into what matters, what is at risk, and what actions should happen next."
        },
        {
            title: "Flexible Senior Expertise",
            description: "Organizations get seasoned VCISO support without needing to hire a full-time executive too early."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Leadership and Grounded in Security.
                        </h2>
