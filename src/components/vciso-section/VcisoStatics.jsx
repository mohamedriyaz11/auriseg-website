...
const stats = [
  { number: '3X', subNumber: '', description: 'Faster Compliance Readiness vs. In-House Hiring' },
  { number: '60%', description: 'Lower Cost Than a Full-Time CISO' },
  { number: '72-Hrs', description: 'Onboarding to Active Security Leadership' },
  { number: '100%', description: 'Board-Ready Reporting. Zero Security Blind Spots. ' },
];
