    ...
    const cards = [
        {
            ...
            description: "Auriseg helps define and refine security strategy based on business goals, current risks, and organizational maturity. The result is a more focused and actionable security direction."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Governance and Risk Oversight",
            description: "VCISO support helps establish stronger governance practices, prioritize risk, and improve visibility for leadership teams. This keeps security decisions tied to business impact and accountability."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Board and Executive Reporting",
            description: "Auriseg prepares clear, leadership-friendly reporting that translates security activity into risk context, program progress, and decision points. This helps executives and boards understand what matters most."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement includes executive advisory, governance support, and strategic planning — designed to help organizations make security decisions with clarity, consistency, and business alignment.
                        </p>
