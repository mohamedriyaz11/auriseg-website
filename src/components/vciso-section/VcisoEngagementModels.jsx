    ...
    const models = [
        {
            ...
            title: "VCISO Advisory Retainer",
            description: "Ongoing access to strategic security leadership, governance support, and leadership-level guidance on priorities and risk."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Project-Based VCISO Support",
            description: "Targeted support for initiatives such as security program design, board reporting, executive workshops, or major transformation efforts."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Interim VCISO Coverage",
            description: "Short-term executive security leadership for organizations between hires, during transitions, or while building a permanent function."
        }
    ];
        ...
        <>
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    ...
                    {/* Built for How You Lead - Heading */}
                    <h2
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for How You Lead - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
