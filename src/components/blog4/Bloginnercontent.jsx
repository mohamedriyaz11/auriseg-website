...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  'From Access to Takeover: How VPN Collapses Your Security Perimeter?',
  'The Visibility Problem',
  'How This Affects the Organization',
  'Why Are VPNs Not Enough?',
  'How Does Auriseg Help the Firm?',
  'Don’t Let Access Turn Into a Breach',
];
...
const SECTIONS = [
  {
    id: 's0',
    heading: 'From Access to Takeover: How VPN Collapses Your Security Perimeter?',
    body: [
      <>
        For years, VPNs have been the backbone of secure remote access.
        But in today’s threat landscape, they’ve quietly become one of the most exploited entry points in enterprise environments.
        <br /><br />

        The problem isn’t access, it’s what comes after.
        <br /><br />

        Once an attacker gains VPN credentials
        <span style={{ color: '#FF5536' }}> (via phishing, credential stuffing, or token theft)</span>,
        they don’t break in; they log in.
        And from that moment, traditional VPN architectures grant far more trust than they should.
        <br /><br />
...

  {
    ...
    body: [
      <>
        A VPN encrypts traffic and hides it from external observers, but it can also hide suspicious activity from the organization’s own security stack if monitoring is not designed around identity, behavior, and east-west traffic.
        <br /><br />

        Traditional VPN logs usually show who connected and when, but not the full chain of actions taken after access was granted.
        <br /><br />

        That creates a major blind spot. Security teams may know a session existed, but not whether the user explored internal systems, accessed sensitive data, or executed unauthorized commands.
        In practice, this makes incident detection slower and forensic analysis much harder.
        <br /><br />

        VPNs encrypt traffic and route it through secure tunnels, which is great for privacy but problematic for visibility.
        Security teams often lose granular insight into:
        <br /><br />

        ● East-west traffic movement inside the network
        <br />
        ● User behavior after initial authentication
        <br />
        ● Application-level anomalies within encrypted sessions
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          This lack of visibility allows attackers to blend in with legitimate traffic,
        </span>
        making it harder for SOC teams to detect abnormal activity until it’s too late.
      </>
    ],
  },
  ...
  {
    id: 's2',
    heading: 'How This Affects the Organization',
    body: [
      <>
        The operational impact is significant.
        If an attacker compromises a VPN account, they may inherit a trusted position inside the network and use that foothold to move from one system to another with minimal friction.
        <br /><br />

        This can lead to:
        <br /><br />

        ● Delayed threat detection because malicious traffic blends into legitimate remote work activity.
        <br />
        ● Wider blast radius because VPN users often gain more access than they actually need.
        <br />
        ● Slower incident response because logs lack enough context to reconstruct attacker behavior.
        <br />
        ● Higher ransomware risk because attackers can quietly map systems, deploy tools, and exfiltrate data before defenders notice.
        <br /><br />

        For organizations with hybrid work, cloud connectivity, and shared infrastructure, the problem becomes even more complex.
        <br /><br />

        The VPN becomes a transit layer, but
        <span style={{ color: '#FF5536' }}>
          {' '}not a security control that can enforce least privilege or continuously verify trust.
        </span>
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: 'Why Are VPNs Not Enough?',
    hasChecklist: true,
    body: [
      <>
        The core issue is that VPNs operate on an outdated trust model.
        Once a session is authenticated, the user is often treated as trusted for the duration of that connection,
        even if their behavior changes or their account is compromised.
        <br /><br />

        That model is especially risky in modern environments where attackers use
        <span style={{ color: '#FF5536' }}>
          {' '}stolen credentials, living-off-the-land techniques, and fast lateral movement
        </span>
        to avoid detection.
        <br /><br />

        A VPN may secure the tunnel, but it does not automatically secure the session,
        the endpoints, or the internal paths an attacker can take after entry.
      </>
    ],
  },
  ...
  {
    id: 's4',
    heading: 'How Does Auriseg Help the Firm?',
    body: [
      <>
        Auriseg helps organizations move beyond the limits of traditional VPN-based security by focusing on
        <span style={{ color: '#FF5536' }}>
          {' '}stronger visibility, tighter control, and proactive testing of attack paths.
        </span>
        <br /><br />

        Auriseg’s approach emphasises identifying weaknesses before attackers can exploit them
        and translating those findings into actionable security improvements.
      </>
    ],
  },
  ...
  {
    id: 's5',
    heading: 'Don’t Let Access Turn Into a Breach',
    body: [
      <>
        VPNs were designed for a different era.
        Today, they can inadvertently accelerate attacks rather than stop them.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          It’s time to rethink access.
        </span>
        <br /><br />

        Auriseg helps you close the gaps, reduce attack surface, and build a resilient, zero-trust-driven security approach.
      </>
    ],
  },
];
