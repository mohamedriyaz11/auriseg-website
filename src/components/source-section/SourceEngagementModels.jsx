    ...
    const models = [
        {
            ...
            description: "Perfect for releases, high-risk modules, or compliance checkpoints. Auriseg performs a focused review of critical code areas and delivers prioritized findings."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Continuous Review Support",
            description: "Embed security into your development cycle with recurring reviews for active repositories, feature branches, and changing application logic."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Secure SDLC Advisory",
            description: "Go beyond finding issues. Auriseg helps improve secure coding practices, review standards, and engineering workflows for long-term resilience."
        }
    ];
        ...
        <>
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    ...
                    {/* Built for How You Build - Heading */}
                    <h2
            ...
            >
                <div className="max-w-[342px] mx-auto">
                    ...
                    {/* Built for How You Build - Heading Mobile */}
                    <h2
                        className="text-center"
                        style={{
                            fontFamily: "'Cabinet Grotesk', sans-serif",
