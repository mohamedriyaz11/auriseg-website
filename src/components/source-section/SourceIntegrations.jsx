...
const ThreatIntegrations = () => {
    const integrations = {
        siem: ['GitHub', 'GitLab', 'Bitbucket', 'Azure Repos'],
        edr: ['Jenkins', 'GitHub Actions', 'GitLab CI', 'Azure DevOps'],
        firewall: ['Java', 'Python', 'JavaScript', 'TypeScript', 'C#', 'PHP', 'Go'],
        cloud: ['Jira', 'Azure Boards', 'Linear', 'Trello']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg fits into your existing engineering workflow — no disruption, no rip-and-replace, and no security theater.
                            </p>
                        </div>
