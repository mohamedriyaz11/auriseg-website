    ...
    const cards = [
        {
            ...
            title: "Secure Code Inspection",
            description: "Auriseg reviews application code for common and advanced security flaws, including injection risks, broken authentication logic, insecure data handling, and unsafe privilege controls."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Vulnerability Validation",
            description: "Every suspicious pattern is validated by security experts to separate real exposure from false positives — so your team gets findings that matter."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Remediation Guidance",
            description: "Auriseg provides clear, prioritized recommendations to fix issues quickly, reduce risk, and improve code quality without slowing delivery."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Every engagement combines expert analysis, tooling, and remediation guidance to help identify security weaknesses, unsafe patterns, and exploitable logic before attackers can use them.
                        </p>
