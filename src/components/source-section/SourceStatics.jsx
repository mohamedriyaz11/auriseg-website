...
const stats = [
  { number: '3X', subNumber: '', description: 'More Vulnerabilities Found vs. Automated Scans Alone' },
  { number: '95%', description: 'Critical Findings Remediated Within 30 Days by Clients' },
  { number: '100%', description: 'Manual Review by Certified Security Engineers' },
  { number: '72-Hrs', description: 'Preliminary Findings Turnaround ' },
];
