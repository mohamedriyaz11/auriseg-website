    ...
    const features = [
        {
            ...
            description: "Security specialists assess code with attacker mindset and engineering context, not just tool-generated output."
        },
        {
            title: "Business-Relevant Findings",
            description: "Issues are ranked by risk, exploitability, and likely impact, so teams know what to fix first."
        },
        {
            title: "Remediation-Ready Output",
            description: "Findings include clear explanations, proof points, and practical fix guidance tailored for developers."
        },
        {
            title: "Fast, Flexible Delivery",
            description: "Auriseg adapts to sprint cycles, release deadlines, and changing codebases without slowing teams down."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Real Security Assurance
                        </h2>
