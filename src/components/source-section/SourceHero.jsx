        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/source-code-review/Source Code Review.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Find the Flaws Before<br />
                                <span style={{ color: '#FF5536' }}>Attackers Do </span>
                            </h1>
                            ...
                            >
                                Auriseg’s Source Code Review uncovers hidden vulnerabilities, insecure logic, and risky code paths before they reach production — helping your teams ship with confidence and verify security from the inside out.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('source-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('source-process-timeline-mobile') || document.getElementById('source-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
