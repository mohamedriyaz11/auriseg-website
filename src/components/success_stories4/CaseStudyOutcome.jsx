...
const CaseStudyOutcome = () => {
  const outcomes =
    [
      {
        number: "90%",
        label: "Network and application assessment coverage achieved"
      },
      {
        number: "24/7",
        label: "Enhanced monitoring of central hosting environment"
      },
      {
        number: "<15m",
        label: "Accelerated response for high-severity vulnerabilities"
      },
      {
        number: "3x",
        label: "Improved remediation throughput and operational efficiency"
      }
    ];
