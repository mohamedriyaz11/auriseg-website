  ...
  const challenges = [
    {
      ...
      description: "Oracle-Forms and legacy web apps require specialized testing."
    },
    {
      icon: "/images/success-stories/icons/icon-alert.png",
      title: "Broad Attack Surface",
      description: "Large, distributed hosting and SAN storage increase exposure."
    },
    {
      icon: "/images/success-stories/icons/icon-soc.png",
      title: "Mixed Testing Requirements",
      description: "Need for both white-box (code/config) and black-box (external) assessments."
    },
    {
      icon: "/images/success-stories/icons/icon-hiring.png",
      title: "Regulatory & Availability Constraints",
      description: "Maintaining service continuity while performing intrusive tests."
    }
  ];
