...
/* ─── DATA ───────────────────────────────────────────────────────────────────── */
const TOC = [
  "Your Tactics Just Got Weaponized: MITRE's Update Shows How Defences Can Be Turned Against Users",
  "What This Means for Organisations",
  "Why This Matters Now",
  "The Message for Organisations Is Clear",
  "How Auriseg Helps",
  "Build a Defence Strategy Against Modern Threats"
];
const TABLE_ROWS = [
...
const SECTIONS = [
  {
    id: 's0',
    heading: "Your Tactics Just Got Weaponized: MITRE's Update Shows How Defences Can Be Turned Against Users",
    body: [
      <>
        Cyber teams understand that attackers think in terms of tactics rather than signatures.
        The MITRE framework illustrates this.
        <br /><br />

        Adversaries exploit the operational realities of modern businesses, such as
        <span style={{ color: '#FF5536' }}>
          {' '}cloud environments, DevOps workflows, identity systems, exposed services and automated infrastructure.
        </span>
        <br /><br />

        This is more than a framework update. It shows security programmes built around isolated alerts,
        disconnected tools or generic compliance checklists miss the bigger picture.
        <br /><br />

        MITRE's updates emphasise structured defensive guidance, including
        <span style={{ color: '#FF5536' }}>
          {' '}Detection Strategies and Analytics
        </span>,
        to help security teams move from reactive alerting to behaviour-based defence.
      </>
    ],
  },
  ...
  {
    id: 's1',
    heading: 'What This Means for Organisations',
    hasTable: true,
    body: [
      <>
        Attackers can disrupt availability, integrity, steal credentials, move laterally,
        and create operational downtime affecting customers, revenue, and trust.
        <br /><br />

        This is the direct organisational impact of MITRE'S Impact tactic,
        designed to cause these very disruptions.
        Its implications matter to security teams as well as leadership, operations, and risk owners.
        <br /><br />

        In practical terms, this means:
        <br /><br />

        ● Identity attacks can become enterprise-wide breaches.
        <br />

        ● Cloud misconfigurations can become persistent and privilege-escalation paths.
        <br />

        ● DevOps compromise can turn trusted automation into a weapon.
        <br />

        ● Unmonitored external exposure can become the first step in a full intrusion.
      </>
    ],
  },
...

  {
    ...
    body: [
      <>
        Static defence doesn't work against modern attack surfaces.
        <br /><br />

        MITRE's latest update reflects an expanded focus on the systems attacker’s abuse,
        such as
        <span style={{ color: '#FF5536' }}> Kubernetes clusters.</span>
        <br /><br />

        It is relevant to security operations, incident response,
        threat hunting, and risk planning.
      </>
    ],
  },
  ...
  {
    id: 's3',
    heading: 'The Message for Organisations Is Clear',
    body: [
      <>
        Map controls to the adversary's behaviour to defend against current threats.
        <br /><br />

        MITRE provides a common language for teams to work together to
        <span style={{ color: '#FF5536' }}>
          {' '}identify weaknesses, prioritise defences and connect intelligence to action.
        </span>
      </>
    ],
  },
...

  {
    ...
    body: [
      <>
        At Auriseg, we help organisations transform into effective defence strategies.
        Our approach is designed to reduce noise, prioritise the most important issues
        and align security controls with the techniques that are most likely to affect your environment.
        <br /><br />

        Our positioning emphasises
        <span style={{ color: '#FF5536' }}>
          {' '}asset-aware scoring, MITRE mapping, guided remediation,
          external attack surface checks and transparent reporting
        </span>,
        all of which drive measurable risk reduction.
        <br /><br />

        Auriseg services are aligned to this challenge:
        threat-informed risk prioritisation and mapping adversary behaviour to the controls that matter most.
        <br /><br />

        ● External attack surface discovery: identifying exposed services,
        misconfigurations and leaked credentials before attackers do.
        <br /><br />

        ● Guided remediation support: translating findings into patching,
        configuration fixes, compensating controls and closure tracking.
        <br /><br />

        ● Executive-ready reporting shows what was found,
        what was fixed, and what risk remains.
      </>
    ],
  },
  ...
  {
    id: 's5',
    heading: 'Build a Defence Strategy Against Modern Threats',
    body: [
      <>
        Partner with Auriseg to assess your attack surface,
        prioritise the highest-risk tactics,
        and build a defence strategy that keeps pace with modern threats.
        <br /><br />

        <span style={{ color: '#FF5536' }}>
          Build stronger visibility, reduce risk, and stay ahead of evolving attackers with Auriseg.
        </span>
      </>
    ],
  },
