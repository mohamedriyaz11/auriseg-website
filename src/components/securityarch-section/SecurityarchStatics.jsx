...
const stats = [
  { number: '200+', subNumber: '', description: 'Security Architecture Engagements Delivered' },
  { number: '95%', description: 'Clients Achieve Target Security Maturity Within 6 Months' },
  { number: '70%', description: 'Reduction in Attack Surface Post-Architecture Review' },
  { number: '100%', description: 'Alignment to NIST, CIS, ISO 27001, and Zero-Trust Frameworks ' },
];
