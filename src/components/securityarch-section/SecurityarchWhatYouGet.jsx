    ...
    const cards = [
        {
            ...
            description: "Auriseg reviews your current security architecture across infrastructure, network, identity, application, and cloud layers to identify weaknesses, control gaps, and design misalignment. The goal is to improve security posture at the foundation level."
        },
        {
            icon: "/icons/soc-augmentation/triage-escalation.png",
            title: "Control Design",
            description: "Every critical control is evaluated for placement, effectiveness, and fit within your environment. Auriseg helps define where controls should live, how they should work together, and how they support both protection and operational efficiency."
        },
        {
            icon: "/icons/soc-augmentation/reporting.png",
            title: "Security-by-Design Guidance",
            description: "You receive actionable recommendations to strengthen architecture decisions, reduce risk exposure, and improve long-term resilience. The focus is on building security into systems early rather than layering it on after problems emerge."
        },
            ...
            >
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div style={{ maxWidth: '1240px' }}>
                        ...
                        >
                            Stronger Architecture. Better Resilience.
                        </h2>
                        ...
                        >
                            Every engagement includes architecture analysis, control review, and design recommendations — built to help organizations create secure, resilient environments without slowing business and technology goals.
                        </p>
