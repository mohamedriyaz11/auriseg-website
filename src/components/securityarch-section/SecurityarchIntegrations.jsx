...
const ThreatIntegrations = () => {
    const integrations = {
        ...
        cloud: ['SIEM platforms', 'cloud security tools', 'access controls', 'segmentation and monitoring technologies']
    };
                ...
                <div style={{ paddingLeft: 'calc(60px + 1cm)', paddingRight: '80px' }}>
                    <div className="max-w-[1240px]">
                        ...
                        >
                            ...
                            >
                                Auriseg works with your existing platforms, cloud environments, and enterprise security tooling — no rip-and-replace required.
                            </p>
                        </div>
