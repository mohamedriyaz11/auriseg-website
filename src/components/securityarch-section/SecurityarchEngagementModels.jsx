    ...
    const models = [
        {
            ...
            description: "A focused review of your current environment to identify design weaknesses, control gaps, and priority improvement areas."
        },
        {
            icon: "/icons/soc_augmentation/fully-managed.png",
            title: "Secure Design Advisory",
            description: "Strategic guidance for teams designing new systems, cloud migrations, application platforms, or hybrid environments."
        },
        {
            icon: "/icons/soc_augmentation/soc-augmentation.png",
            title: "Ongoing Architecture Advisory",
            description: "Continuous support for organizations that need recurring architecture review, design validation, and control optimization over time."
        }
    ];
