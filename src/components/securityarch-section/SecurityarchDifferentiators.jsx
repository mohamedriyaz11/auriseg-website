...
const IotDifferentiators = () => {
    ...
    const features = [
        {
            title: "Security-by-Design Focus",
            description: "Auriseg helps teams address risks at the design stage, before weaknesses become operational problems."
        },
        {
            title: "End-to-End Architecture Perspective",
            description: "Reviews consider identity, network, application, infrastructure, and cloud layers together rather than in isolation."
        },
        {
            title: "Actionable Design Recommendations",
            description: "Findings are delivered as practical architecture improvements, not just theoretical concerns."
        },
        {
            title: "Business-Aligned Security Decisions",
            description: "Architecture guidance is shaped around resilience, usability, scalability, and operational realities."
        }
    ];
                ...
                >
                    ...
                    <div style={{ flex: '0 0 48%', maxWidth: '48%' }}>
                        ...
                        <h2 style={{
                            ...
                            Built for Design and Grounded in Security
                        </h2>
