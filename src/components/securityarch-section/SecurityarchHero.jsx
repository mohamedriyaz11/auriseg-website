        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                    <img
                        src="/images/security-architecture/Security Architecture.jpg"
                ...
                <div className="relative z-10 w-full h-full flex items-center">
                    <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
                        <div className="max-w-[900px]">
                            ...
                            >
                                Build the Right <br />Controls Into the <br />
                                <span style={{ color: '#FF5536' }}>Right Layers</span>
                            </h1>
                            ...
                            >
                                Auriseg helps organizations design and strengthen security architecture across cloud, network, applications, identity, and infrastructure — so security is embedded from the start, aligned to risk, and built to scale.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        const el = document.getElementById('securityarch-process-timeline');
                                        if (el) {
                                            const offset = 100;
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
                        ...
                        <div className="text-center mb-4 w-full">
                            ...
                            >
                                Build the Right Controls Into the
                            </h1>
                            <h1
                                style={{
                                    fontFamily: "'Cabinet Grotesk', sans-serif",
                        ...
                        <div className="flex flex-col gap-3 w-full items-center">
                            ...
                            <button
                                onClick={() => {
                                    const el = document.getElementById('securityarch-process-timeline-mobile') || document.getElementById('securityarch-process-timeline');
                                    if (el) {
                                        const offset = 100;
                                        const top = el.getBoundingClientRect().top + window.scrollY - offset;
                                        window.scrollTo({ top, behavior: 'smooth' });
